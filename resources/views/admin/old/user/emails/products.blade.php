...
<head>
	...
	<title>Product @if($product->approved) Approved @else Rejected @endif | Expiring Soon</title>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														...
														<tr>
															<td class="text-btn-large" bgcolor="#00FA00" style="font-family:'Poppins', Arial,sans-serif; font-size:15px; line-height:18px; text-align:center; border:0px solid #cd6502; padding:15px 35px;">
																<a href="{{route('vendor.shop.product.list',[$product->shop,$product])}}" target="_blank" class="link-2" style="color:#fff; text-decoration:none;padding:15px 180px;">
																	<span class="link-2" style="color:#fff; text-decoration:none;">Manage Product</span>
																</a>
															</td>
														</tr> 
