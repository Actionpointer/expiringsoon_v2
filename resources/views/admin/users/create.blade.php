                        ...
                        @forelse ($documents as $document)
                            <tr>
                                ...
                                <td class="dashboard__order-history-table-item order-id" >
                                    <img @if(!$document->user->pic) src="{{asset('img/avatar.png')}}" @else src="{{Storage::url($document->user->pic)}}" @endif alt="{{$document->user->fname}} {{$document->user->lname}}" style="width:50px;border-radius:50px;border:1px solid #ddd;padding:3px" />
                                </td>
                                <!-- Date  -->
                                ...
                                <td class=" dashboard__order-history-table-item order-details ">
                                    <a href="admin-editcustomer.php?uid={{$document->user->id}}"> View User</a>
                                </td>
                            </tr>
                        @empty
