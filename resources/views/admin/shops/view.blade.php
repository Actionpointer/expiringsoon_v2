                  ...
                  <div class="dashboard__content-card-body">
                    <table class="table small">
                        ...
                        @forelse($shop->kyc->sortByDesc('user_id') as $kyc)
                              ...
                              <td>
                                <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">                                 
                                    ...
                                    <button class="dropdown-item" type="button" data-bs-toggle="modal" data-bs-target="#rateedit{{$kyc->id}}">Reject</button>
                                  </div>
                                </div>
                            ...
                            @else
                            <tr>
                                <td><a href="{{Storage::url($kyc->document)}}">{{$kyc->type}} <small>{{$kyc->doctype}}</a></small></td>
