      ...
      <div class="row dashboard__content">
        ...
        <div class="col-lg-9 section--xl pt-0" style="padding:10px;font-size:13px">
            <div class="dashboard__order-history-title" style="margin:auto;width:95%;border-bottom:1px solid #ddd;margin-bottom:10px">
              ...
              <a href="#" class="font-body--lg-500">N{{ number_format($payouts->count(), 2)}} Total</a>
            </div>
            <div class="container">
                            ...
                            <tr class="likeditem" style="border-bottom:1px solid #f1f1f1">
                                ...
                                <div style="margin-top:10px">
                                    <span class="font-body--lg-500" style="color:#000">
                                        {{$payout->user->fname.' '.$payout->user->lname}}
                                    </span>
                                    <br />
                                    <span style="font-size:12px;color:#888">
                                        {{$payout->user->bankinfo->bank}}<br />{{$payout->user->bankinfo->acctname}} > 
                                        <span style="color:#000">{{$payout->user->bankinfo->acctno}}</span>
                                    </span>
                                </div>
                                </td>
                                <!-- Price  -->
