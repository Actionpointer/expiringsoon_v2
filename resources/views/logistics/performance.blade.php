...
<div class="content container-fluid">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h1 class="page-header-title">Performance Metrics</h1>
            </div>
            <div class="col-auto">
    ...
    <div class="row mb-4">
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-0">
            <div class="card h-100">
                <div class="card-body">
                    <h6 class="card-subtitle mb-2">On-Time Delivery Rate</h6>
                    <div class="row align-items-center gx-2">
                        <div class="col">
                            <span class="display-4 text-dark">96.8%</span>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card h-100">
                <div class="card-body">
                    <h6 class="card-subtitle mb-2">Operating Cost</h6>
                    <div class="row align-items-center gx-2">
                        <div class="col">
                            <span class="display-4 text-dark">$4.2M</span>
                        </div>
                        <div class="col-auto">
    ...
    <div class="row mb-4">
                ...
                <div class="card-header">
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item active" href="#">Delivery Time</a>
                            <a class="dropdown-item" href="#">Customer Ratings</a>
                            <a class="dropdown-item" href="#">Cost per Delivery</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-4">
            <div class="card h-100">
                <div class="card-header">
                    <h4 class="card-header-title">Company Rankings</h4>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="text-primary fw-bold me-2">1.</span>
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="text-primary fw-bold me-2">2.</span>
                                            <div>SpeedCargo Express</div>
                                        </div>
                                    </td>
                                    <td>96.8%</td>
                                    <td>
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card h-100">
                <div class="card-header">
                    <h4 class="card-header-title">Cost Metrics</h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-borderless table-thead-bordered table-nowrap">
