                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="pills-customer" role="tabpanel" aria-labelledby="pills-customer-tab">
                        <div class="row products-tab__feedback">
                            @if($product->reviews->where('report',false)->isNotEmpty())
                                <div class="col-lg-4 order-lg-0 order-1">
                                    <div class="col4 -phm">
                                        <div class="text-center">
                                            <h6 class="mb-4">Verified Reviews (28)</h6>
                                            <div class="h3">
                                                <span class="">4.4</span>/5
                                            </div>
                                            ...
                                            <p class="-fs16 -pts">28 verified ratings</p>
                                    ...
                                    <div class="feedback">
                                        ...
                                        <div class="products-tab__feedback-content">
                                            <div class="products-tab__feedback-content-top">
                                                <div class="user-details">
                                                    <div class="user-details__img">
                                                        <img src="{{asset('src/images/user/img-01.png')}}" alt="user-img">
                                                    </div>
                                                    <div class="user-details__info">
                                        ...
                                        <div class="products-tab__feedback-content">
                                            <div class="products-tab__feedback-content-top">
                                                <div class="user-details">
                                                    <div class="user-details__img">
                                                        <img src="{{asset('src/images/user/img-03.png')}}" alt="user-img">
                                                    </div>
                                                    <div class="user-details__info">
                                        ...
                                        <div class="products-tab__feedback-content">
                                            <div class="products-tab__feedback-content-top">
                                                <div class="user-details">
                                                    <div class="user-details__img">
                                                        <img src="{{asset('src/images/user/img-04.png')}}" alt="user-img">
                                                    </div>
                                                    <div class="user-details__info">
