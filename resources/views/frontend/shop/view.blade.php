                                                                        ...
                                                                        <a href="{{route('product.show',$product)}}" class="cards-md__info-left">
                                                                            ...
                                                                            <div class="cards-md__info-price">
                                                                                @if($product->price > $product->amount)
                                                                                    ...
                                                                                    <del class="font-body--lg-400" style="color:#00b207">{!!cache('settings')['currency_symbol']!!}{{number_format($product->price, 0)}}</del>
                                                                                @else
                                                                                    <span class="font-body--lg-500">{!!cache('settings')['currency_symbol']!!}{{number_format($product->price, 0)}}</span>
                                                                                @endif
                                                                            </div>
                                                            ...
                                                            <div class="products-tab__feedback-content-top">
                                                                <div class="user-details">
                                                                    <div class="user-details__img">
                                                                        <img src="{{asset('src/images/user/img-02.png')}}" alt="user-img">
                                                                    </div>
