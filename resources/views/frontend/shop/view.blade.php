                                            ...
                                            @if($product->expiry !='' && $product->expiry->diffInDays(now()) < 90 && $product->stock > 0)
                                                ...
                                                <div class="cards-md__favs-list">
                                                    <span class="action-btn">
                                                        <svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg" id2="{{$product->id}}" class="add-to-wish">
                                        ...
                                        <div class="cards-md__info d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="cards-md__info-right">
                                                @if($product->stock > 0)
                                                    <span class="action-btn">
                                                        @if($product->expiry !='' && $product->expiry->diffInDays(now()) < 90)
                                                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg" class="add-to-cart" id3="{{$product->id}}" data-price="{{$sale}}" data-product="{{$product->name}}" data-photo="./storage/{{$product->photo}}">
                                                                <path
