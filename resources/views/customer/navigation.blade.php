    ...
    <nav class="dashboard__nav">
      ...
      <ul class="dashboard__nav-item">
        <li class="dashboard__nav-item-link active">
          <a href="{{route('home')}}" class="font-body--lg-400">
            <span class="icon">
      ...
      @if(auth()->user()->role =='Vendor' && auth()->user()->staff->first()->role == 'owner')
        <hr>
      ...
      <button class="filter-icon">
        <svg width="22" height="19" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M18 5.75C18.4142 5.75 18.75 5.41421 18.75 5C18.75 4.58579 18.4142 4.25 18 4.25V5.75ZM9 4.25C8.58579 4.25 8.25 4.58579 8.25 5C8.25 5.41421 8.58579 5.75 9 5.75V4.25ZM18 4.25H9V5.75H18V4.25Z" fill="white" />
          <path d="M13 14.75C13.4142 14.75 13.75 14.4142 13.75 14C13.75 13.5858 13.4142 13.25 13 13.25V14.75ZM4 13.25C3.58579 13.25 3.25 13.5858 3.25 14C3.25 14.4142 3.58579 14.75 4 14.75V13.25ZM13 13.25H4V14.75H13V13.25Z"
            fill="white" />
