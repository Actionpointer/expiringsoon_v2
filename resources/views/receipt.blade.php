                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="dashboard__order-history-table-item order-date align-middle">
                                {!!cache('settings')['currency_symbol']!!} {{number_format($settlement->order->subtotal, 2)}}
                            </td>
                            <!-- commission -->
                            <td class="dashboard__order-history-table-item order-total align-middle">
                              <p class="order-total-price">{!!cache('settings')['currency_symbol']!!}  {{number_format($settlement->order->commission(),2)}}</p>
                            </td>
                            <!-- Subtotal  -->     
                        ...
                        @if($settlement->order->deliveryByVendor())
                          <tr>
                              ...
                              <!-- Price  -->
                              <td class="dashboard__order-history-table-item order-date align-middle ">
                                  {!!cache('settings')['currency_symbol']!!} {{number_format($settlement->order->deliveryfee, 2)}}
                              </td>
                              <td class="dashboard__order-history-table-item order-total align-middle">
