                ...
                <div class="card-body">
                    <form id="notificationSettingsForm" action="#" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="mb-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="emailChannel" name="channels[email]" checked>
                            ...
                            <div class="mb-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="smsChannel" name="channels[sms]" checked>
                                ...
                                <div class="mt-2 ps-4">
                                    ...
                                    <input type="tel" class="form-control" id="phoneNumber" name="phone_number" value="+1 (234) 567-8901">
                                </div>
                            </div>
                            
                            <div class="mb-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="pushChannel" name="channels[push]" checked>
                            ...
                            <div class="mb-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="inAppChannel" name="channels[in_app]" checked>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="form-check d-flex justify-content-center">
                                                    <input class="form-check-input" type="checkbox" id="newOrderEmail" name="notifications[new_order][email]" checked>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="form-check d-flex justify-content-center">
                                                    <input class="form-check-input" type="checkbox" id="newOrderSms" name="notifications[new_order][sms]" checked>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="form-check d-flex justify-content-center">
                                                    <input class="form-check-input" type="checkbox" id="newOrderPush" name="notifications[new_order][push]" checked>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="form-check d-flex justify-content-center">
                                                    <input class="form-check-input" type="checkbox" id="newOrderInApp" name="notifications[new_order][in_app]" checked>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="mb-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="marketingEmails" name="marketing[emails]" checked>
                            ...
                            <div class="mb-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="platformUpdates" name="marketing[platform_updates]" checked>
                            ...
                            <div class="mb-4">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="tipsAndTricks" name="marketing[tips]" checked>
...
@push('scripts')
<script>
    // Toggle related checkboxes when main channel is toggled
    document.querySelectorAll('[id$="Channel"]').forEach(function(channelToggle) {
        channelToggle.addEventListener('change', function() {
            const channel = this.id.replace('Channel', '').toLowerCase();
            const isChecked = this.checked;
            
            // Disable/enable all channel checkboxes of this type
            document.querySelectorAll(`[id$="${channel.charAt(0).toUpperCase() + channel.slice(1)}"][type="checkbox"]`).forEach(function(checkbox) {
