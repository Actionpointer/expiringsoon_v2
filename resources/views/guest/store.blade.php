				...
				<div class="row">
					...
					<div class="col-12 col-lg-9 col-md-8">
						<div class="mb-8 bg-light d-lg-flex justify-content-lg-between rounded">
							...
							<div class="py-4">
								<!-- img -->
								<img src="{{asset('frontend/images/svg-graphics/store-graphics.svg')}}" alt="" class="img-fluid" />
							</div>
						</div>
							...
							<div class="col">
								...
								<div class="card card-product">
									<div class="card-body">
										...
										<h2 class="fs-6">
											<a href="#!" class="text-inherit text-decoration-none">Haldiram's Sev
												Bhujia</a>
										</h2>
										<div>
											<!-- rating -->
							...
							<div class="col">
								...
								<div class="card card-product">
									<div class="card-body">
										...
										<h2 class="fs-6">
											<a href="#!" class="text-inherit text-decoration-none">Cadbury 5 Star
												Chocolate</a>
										</h2>
										<div class="text-warning">
											<small>
							...
							<div class="col">
								...
								<div class="card card-product">
									<div class="card-body">
										...
										<h2 class="fs-6">
											<a href="#!" class="text-inherit text-decoration-none">Onion Flavour
												Potato</a>
										</h2>
										<div class="text-warning">
											<small>
								...
								<div class="card card-product">
									<div class="card-body">
										<div class="text-center position-relative">
											...
											<a href="#!">
												<!-- img -->
												<img src="{{asset('frontend/images/products/product-img-5.jpg')}}"
													alt="Grocery Ecommerce Template" class="mb-3 img-fluid" />
											</a>
											<!-- btn action -->
											<div class="card-product-action">
										...
										<h2 class="fs-6">
											<a href="#!" class="text-inherit text-decoration-none">Salted Instant
												Popcorn</a>
										</h2>
										<div class="text-warning">
											<small>
								...
								<div class="card card-product">
									<div class="card-body">
										<div class="text-center position-relative">
											...
											<a href="#!">
												<!-- img -->
												<img src="{{asset('frontend/images/products/product-img-6.jpg')}}"
													alt="Grocery Ecommerce Template" class="mb-3 img-fluid" />
											</a>
											<!-- btn action -->
											<div class="card-product-action">
										...
										<h2 class="fs-6">
											<a href="#!" class="text-inherit text-decoration-none">Blueberry Greek
												Yogurt</a>
										</h2>
										<div>
											<!-- rating -->
								...
								<div class="card card-product">
									<div class="card-body">
										<div class="text-center position-relative">
											...
											<a href="#!">
												<!-- img -->
												<img src="{{asset('frontend/images/products/product-img-7.jpg')}}"
													alt="Grocery Ecommerce Template" class="mb-3 img-fluid" />
											</a>
											<!-- btn action -->
											<div class="card-product-action">
										...
										<h2 class="fs-6">
											<a href="#!" class="text-inherit text-decoration-none">Britannia Cheese
												Slices</a>
										</h2>
										<div class="text-warning">
											<small>
								...
								<div class="card card-product">
									<div class="card-body">
										<div class="text-center position-relative">
											...
											<a href="#!">
												<!-- img -->
												<img src="{{asset('frontend/images/products/product-img-8.jpg')}}"
													alt="Grocery Ecommerce Template" class="mb-3 img-fluid" />
											</a>
											<!-- btn action -->
											<div class="card-product-action">
										...
										<h2 class="fs-6">
											<a href="#!" class="text-inherit text-decoration-none">Kellogg's Original
												Cereals</a>
										</h2>
										<div class="text-warning">
											<small>
								...
								<div class="card card-product">
									<div class="card-body">
										<div class="text-center position-relative">
											...
											<a href="#!">
												<!-- img -->
												<img src="{{asset('frontend/images/products/product-img-9.jpg')}}"
													alt="Grocery Ecommerce Template" class="mb-3 img-fluid" />
											</a>
											<!-- btn action -->
											<div class="card-product-action">
										...
										<h2 class="fs-6">
											<a href="#!" class="text-inherit text-decoration-none">Slurrp Millet
												Chocolate</a>
										</h2>
										<div class="text-warning">
											<small>
								...
								<div class="card card-product">
									<div class="card-body">
										<div class="text-center position-relative">
											...
											<a href="#!">
												<!-- img -->
												<img src="{{asset('frontend/images/products/product-img-10.jpg')}}"
													alt="Grocery Ecommerce Template" class="mb-3 img-fluid" />
											</a>
											<!-- btn action -->
											<div class="card-product-action">
										...
										<h2 class="fs-6">
											<a href="#!" class="text-inherit text-decoration-none">Amul Butter - 500
												g</a>
										</h2>
										<div class="text-warning">
											<small>
