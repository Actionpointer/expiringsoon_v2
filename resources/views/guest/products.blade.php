                              ...
                              <div id="flush-collapseFour" class="accordion-collapse collapse"
                                 ...
                                 <div>
                                    <ul class="nav flex-column ms-3">
                                       ...
                                       <!-- nav item -->
                                       <li class="nav-item"><a href="#!" class="nav-link">Concentrates & Syrups</a>
                                       </li>
                                       <!-- nav item -->
                                       <li class="nav-item"><a href="#!" class="nav-link">Detox & Energy Drinks</a>
                                       </li>
                                       <!-- nav item -->
                  ...
                  <div class="col">
                     ...
                     <div class="card card-product">
                        <div class="card-body">
                           ...
                           <h2 class="fs-6"><a href="{{route('product',1)}}"
                  ...
                  <div class="col">
                     ...
                     <div class="card card-product">
                        <div class="card-body">
                           <!-- badge -->
                           <div class="text-center position-relative">
                              <a href="{{route('product',1)}}"><img src="{{asset('frontend/images/products/product-img-3.jpg')}}"
                  ...
                  <div class="col">
                     ...
                     <div class="card card-product">
                        <div class="card-body">
                           <!-- badge -->
                           <div class="text-center position-relative">
                              <a href="{{route('product',1)}}"><img src="{{asset('frontend/images/products/product-img-5.jpg')}}"
                                    alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                              <!-- action btn -->
                              <div class="card-product-action">
                                 <a href="#!" class="btn-action" data-bs-toggle="modal"
                  ...
                  <div class="col">
                     ...
                     <div class="card card-product">
                        <div class="card-body">
                           <!-- badge -->
                           <div class="text-center position-relative">
                              <a href="{{route('product',1)}}"><img src="{{asset('frontend/images/products/product-img-7.jpg')}}"
                                    alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                              <!-- action btn -->
                              <div class="card-product-action">
                                 <a href="#!" class="btn-action" data-bs-toggle="modal"
                  ...
                  <div class="col">
                     ...
                     <div class="card card-product">
                        <div class="card-body">
                           <!-- badge -->
                           <div class="text-center position-relative">
                              <a href="{{route('product',1)}}"><img src="{{asset('frontend/images/products/product-img-8.jpg')}}"
                                    alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                              <!-- action btn -->
                              <div class="card-product-action">
                                 <a href="#!" class="btn-action" data-bs-toggle="modal"
                  ...
                  <div class="col">
                     ...
                     <div class="card card-product">
                        <div class="card-body">
                           <!-- badge -->
                           <div class="text-center position-relative">
                              <a href="{{route('product',1)}}"><img src="{{asset('frontend/images/products/product-img-9.jpg')}}"
                                    alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                              <!-- action btn -->
                              <div class="card-product-action">
                                 <a href="#!" class="btn-action" data-bs-toggle="modal"
                  ...
                  <div class="col">
                     ...
                     <div class="card card-product">
                        <div class="card-body">
                           <!-- badge -->
                           <div class="text-center position-relative">
                              <a href="{{route('product',1)}}"><img src="{{asset('frontend/images/products/product-img-10.jpg')}}"
                                    alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                              <!-- action btn -->
                              <div class="card-product-action">
                                 <a href="#!" class="btn-action" data-bs-toggle="modal"
                           ...
                           <h2 class="fs-6"><a href="{{route('product',1)}}" class="text-inherit text-decoration-none">Amul
                                 Butter - 500 g</a></h2>
                           <div class="text-warning">
                              <!-- rating -->
                              <small>
