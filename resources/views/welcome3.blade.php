...
<head>
   ...
   <title>Homepage v3 - eCommerce HTML Template - FreshCart</title>
...
<body>
               ...
               <ul class="navbar-nav navbar-nav-offcanvac">
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <ul class="dropdown-menu">
                        ...
                        <li>
                           <a class="dropdown-item" href="../pages/shop-single-2.html">Shop Single v2</a>
                        </li>
                  ...
                  <li class="nav-item dropdown">
                     ...
                     <ul class="dropdown-menu">
                        <li class="dropdown-submenu">
                           <a class="dropdown-item dropdown-list-group-item dropdown-toggle" href="#">Dairy, Bread &
                              Eggs</a>
                           <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu">
                           <a class="dropdown-item dropdown-list-group-item dropdown-toggle" href="#">Vegetables &
                              Fruits</a>
                           <ul class="dropdown-menu">
                        ...
                        <li class="dropdown-submenu">
                           <a class="dropdown-item dropdown-list-group-item dropdown-toggle" href="#">Cold Drinks &
                              Juices</a>
                           <ul class="dropdown-menu">
   ...
   <main>
            ...
            <div class="row">
               <div class="col-xxl-8 col-xl-7">
                  ...
                  <div class="hero-slider">
                     <div
                        style="background: url({{asset('frontend/images/slider/slider-image-1.jpg')}}) no-repeat; background-size: cover; border-radius: 0.5rem">
                     ...
                     <!-- img -->
                     <div
                        style="background: url({{asset('frontend/images/slider/slider-image-2.jpg')}}) no-repeat; background-size: cover; border-radius: 0.5rem">
                     ...
                     <!-- img -->
                     <div
                        style="background: url({{asset('frontend/images/slider/slider-image-3.jpg')}}) no-repeat; background-size: cover; border-radius: 0.5rem">
                        <div class="ps-lg-12 py-lg-16 col-xxl-7 col-lg-9 py-14 ps-8 text-xs-center">
                           <!-- badge -->
                           <div class="d-flex align-items-center mb-4">
                              <span>Exclusive Offer</span>
               ...
               <div class="col-xxl-4 col-xl-5 col-12 d-lg-flex d-xl-block gap-3 gap-xl-0">
                  <div class="flex-fill px-8 py-9 mb-6 rounded"
                     style="background: url({{asset('frontend/images/banner/ad-banner-1.jpg')}}) no-repeat; background-size: cover">
                     <div>
                  ...
                  <div class="flex-fill px-8 py-8 rounded"
                     style="background: url({{asset('frontend/images/banner/ad-banner-2.jpg')}}) no-repeat; background-size: cover">
                     <!-- Banner Content -->
                     <div>
                        <!-- Banner Content -->
               ...
               <div class="row">
                  ...
                  <div class="col-lg-2 col-md-4 col-6">
                     <div class="text-center mb-10">
                        <!-- img -->
                        <a href="#"><img src="{{asset('frontend/images/category/dairy-bread-eggs.png')}}" alt=""
                              class="card-image rounded-circle" /></a>
                        <!-- text -->
                        <div class="mt-4">
                           <h5 class="fs-6 mb-0"><a href="shop-grid.html" class="text-inherit">Dairy, Bread & Eggs</a>
                           </h5>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-2 col-md-4 col-6">
                     <div class="text-center mb-10">
                        <!-- img -->
                        <a href="#"><img src="{{asset('frontend/images/category/fruits-vegetables.png')}}" alt=""
                              class="card-image rounded-circle" /></a>
                        <div class="mt-4">
                           <!-- text -->
                           <h5 class="fs-6 mb-0"><a href="shop-grid.html" class="text-inherit">Fruits & Vegetables</a>
                           </h5>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-2 col-md-4 col-6">
                     <div class="text-center mb-10">
                        <!-- img -->
                        <a href="#"><img src="{{asset('frontend/images/category/snack-munchies.png')}}" alt=""
                              class="card-image rounded-circle" /></a>
                        <!-- text -->
                        <div class="mt-4">
                  ...
                  <div class="col-lg-2 col-md-4 col-6">
                     <div class="text-center mb-10">
                        <!-- img -->
                        <a href="#"><img src="{{asset('frontend/images/category/bakery-biscuits.png')}}" alt=""
                              class="card-image rounded-circle" /></a>
                        <!-- text -->
                        <div class="mt-4">
                           <h5 class="fs-6 mb-0"><a href="shop-grid.html" class="text-inherit">Bakery & Biscuits</a>
                           </h5>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-2 col-md-4 col-6">
                     <div class="text-center mb-10">
                        <!-- img -->
                        <a href="#"><img src="{{asset('frontend/images/category/instant-food.png')}}" alt=""
                              class="card-image rounded-circle" /></a>
                        <!-- text -->
                        <div class="mt-4">
                  ...
                  <div class="col-lg-2 col-md-4 col-6">
                     <div class="text-center mb-10">
                        <!-- img -->
                        <a href="#"><img src="{{asset('frontend/images/category/tea-coffee-drinks.png')}}" alt=""
                              class="card-image rounded-circle" /></a>
                        <!-- text -->
                        <div class="mt-4">
                           <h5 class="fs-6 mb-0"><a href="shop-grid.html" class="text-inherit">Tea, Coffee & Drinks</a>
                           </h5>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-2 col-md-4 col-6">
                     <div class="text-center mb-10">
                        <!-- img -->
                        <a href="#"><img src="{{asset('frontend/images/category/cold-drinks-juices.png')}}" alt=""
                              class="card-image rounded-circle" /></a>
                        <!-- text -->
                        <div class="mt-4">
                           <h5 class="fs-6 mb-0"><a href="shop-grid.html" class="text-inherit">Cold Drinks & Juices</a>
                           </h5>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-2 col-md-4 col-6">
                     <div class="text-center mb-10">
                        <!-- img -->
                        <a href="#"><img src="{{asset('frontend/images/category/chicken-meat-fish.png')}}" alt=""
                              class="card-image rounded-circle" /></a>
                        <!-- text -->
                        <div class="mt-4">
                           <h5 class="fs-6 mb-0"><a href="shop-grid.html" class="text-inherit">Chicken, Meat & Fish</a>
                           </h5>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-2 col-md-4 col-6">
                     ...
                     <div class="text-center mb-10">
                        <!-- img -->
                        <a href="#"><img src="{{asset('frontend/images/category/baby-care.png')}}" alt=""
                              class="card-image rounded-circle" /></a>
                        <!-- text -->
                        <div class="mt-4">
                  ...
                  <div class="col-lg-2 col-md-4 col-6">
                     <div class="text-center mb-10">
                        <!-- img -->
                        <a href="#"><img src="{{asset('frontend/images/category/cleaning-essentials.png')}}" alt=""
                              class="card-image rounded-circle" /></a>
                        <!-- img -->
                        <div class="mt-4">
                           <h5 class="fs-6 mb-0"><a href="shop-grid.html" class="text-inherit">Cleaning Essentials</a>
                           </h5>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-2 col-md-4 col-6">
                     <div class="text-center mb-10">
                        <!-- img -->
                        <a href="#"><img src="{{asset('frontend/images/category/pet-care.png')}}" alt=""
                              class="card-image rounded-circle" /></a>
                        <!-- text -->
                        <div class="mt-4">
                  ...
                  <div class="col-lg-2 col-md-4 col-6">
                     <div class="text-center mb-10">
                        <!-- img -->
                        <a href="#"><img src="{{asset('frontend/images/category/atta-rice-dal.png')}}" alt=""
                              class="card-image rounded-circle" /></a>
                        <!-- text -->
                        <div class="mt-4">
                           ...
                           <ul class="nav nav-pills nav-scroll border-bottom-0 gap-1" id="nav-tab" role="tablist">
                              ...
                              <li class="nav-item">
                                 ...
                                 <a href="#" class="nav-link" id="nav-bakery-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-bakery" role="tab" aria-controls="nav-bakery"
                                    aria-selected="false">
                                    Bakery & Biscuits
                                 </a>
                              </li>
                              ...
                              <li class="nav-item">
                                 ...
                                 <a href="#" class="nav-link" id="nav-tea-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-tea" role="tab" aria-controls="nav-tea" aria-selected="false">
                                    Tea, Coffee & Drinks
                                 </a>
                              </li>
                              <!-- nav item -->
                              <li class="nav-item">
                                 ...
                                 <a href="#" class="nav-link" id="nav-drinks-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-drinks" role="tab" aria-controls="nav-drinks"
                                    aria-selected="false">
                                    Cold Drinks & Juices
                                 </a>
                              </li>
            ...
            <div class="row">
               <div class="col-12">
                  ...
                  <div class="tab-content" id="nav-tabContent">
                              ...
                              <div class="card card-product-v2 h-100">
                                 <div class="card-body position-relative">
                                    ...
                                    <h2 class="fs-6"><a href="#!" class="text-inherit text-decoration-none">Kellogg's
                                          Special K Original Cereal</a></h2>
                                    <div>
                                       <!-- rating -->
                                       <small class="text-warning">
                                          <i class="bi bi-star-fill"></i>
                           ...
                           <div class="col">
                              ...
                              <div class="card card-product-v2 h-100">
                                 <div class="card-body position-relative">
                                    ...
                                    <!-- title -->
                                    <h2 class="fs-6"><a href="#!" class="text-inherit text-decoration-none">Slurrp Farm
                                          No Maida Millet Pancake Mix</a></h2>
                                    <div>
                                       <!-- rating -->
                                       <small class="text-warning">
                                          <i class="bi bi-star-fill"></i>
                     ...
                     <div class="tab-pane fade" id="nav-snackMunchies" role="tabpanel"
                     ...
                     <div class="tab-pane fade" id="nav-bakery" role="tabpanel" aria-labelledby="nav-bakery-tab"
                        tabindex="0">
                        <div class="row row-cols-2 row-cols-xl-5 row-cols-md-3 g-4">
                           <div class="col">
                              <!-- card -->
            ...
            <div class="row">
               <div class="col-12">
                  <div class="mb-4 bg-light d-lg-flex justify-content-between align-items-center rounded">
                     ...
                     <div class="p-6 d-lg-block d-none"><img src="{{asset('frontend/images/svg-graphics/store-graphics.svg')}}"
               ...
               <div class="col mb-lg-0">
                  <div class="card card-product-v2 h-100">
                     <div class="card-body position-relative text-center">
                        ...
                        <div class="mt-3"><span class="text-uppercase small text-primary">In Stock</span></div>
                        <div class="mt-4">
                     ...
                     <div class="card-body position-relative text-center">
                        ...
                        <div class="mt-4">
                           ...
                           <div class="my-3">
                              <small>
                                 the available products :
                                 <span class="text-dark fw-bold">34</span>
                              </small>
                           </div>
                        </div>
                        <!-- btn -->
                     ...
                     <div class="card-body position-relative text-center">
                        ...
                        <div class="mt-4">
                           ...
                           <div class="my-3">
                              <small>
                                 the available products :
                                 <span class="text-dark fw-bold">67</span>
                              </small>
                           </div>
                        </div>
                        <!-- btn -->
               ...
               <div class="col mb-lg-0">
                  <div class="card card-product-v2 h-100">
                     <div class="card-body position-relative text-center">
                        <div class="text-center position-relative">
                           <!-- img -->
                           <a href="#!"><img src="{{asset('frontend/images/products/product-img-10.jpg')}}"
                                 alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
                           <!-- action btn -->
                           <div class="product-action-btn">
                              <a href="#!" class="btn-action mb-1" data-bs-toggle="modal"
                        ...
                        <div class="mb-3">
                           ...
                           <span class="text-muted text-decoration-line-through ms-1">$29</span>
                        </div>
                        <!-- title -->
                        <h2 class="fs-6"><a href="#!" class="text-inherit text-decoration-none">Amul Butter - 500g</a>
                        </h2>
                        <div>
                           <!-- rating -->
                           <small class="text-warning">
                           ...
                           <span class="text-muted small">4.3(68)</span>
                        </div>

                        <div class="mt-3"><span class="text-uppercase small text-primary">In Stock</span></div>
                        <div class="mt-4">
                           <div class="progress mt-6" style="height: 8px">
                              <div class="progress-bar bg-gray-400" role="progressbar" style="width: 44%"
                                 aria-valuenow="44" aria-valuemin="0" aria-valuemax="100"></div>
                           </div>
                           <div class="my-3">
                              <small>
                                 the available products :
                                 <span class="text-dark fw-bold">44</span>
                              </small>
                           </div>
                        </div>
                        <!-- btn -->
      ...
      <section class="bg-dark"
         style="background: url({{asset('frontend/images/svg-graphics/pattern.svg')}}) no-repeat; background-size: cover; background-position: center">
         <div class="container">
            <!-- row -->
            <div class="row">
                  ...
                  <div class="row align-items-center">
                     ...
                     <div class="col-md-6">
                        <div class="text-white mt-8 mt-lg-0">
                           ...
                           <p class="text-white-50">Join our email subscription now to get updates on promotions and
                              coupons.</p>
                           <!-- form -->
                     ...
                     <div class="col-md-6">
                        <div class="text-center">
                           <!-- img -->
                           <img src="{{asset('frontend/images/png/girl-email.png')}}" alt="" class="img-fluid" />
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <!-- Javascript-->
   <!-- Libs JS -->
   <!-- <script src="frontend/libs/jquery/dist/jquery.min.js"></script> -->
