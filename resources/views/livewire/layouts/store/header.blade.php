                        ...
                        <div data-simplebar style="height: 250px">
                            ...
                            <ul class="list-group list-group-flush notification-list-scroll fs-6">
                                ...
                                <li class="list-group-item px-5 py-4 list-group-item-action active">
                                    <a href="#!" class="text-muted">
                                        <div class="d-flex">
                                            <img src="{{ asset('frontend/images/avatar/avatar-1.jpg') }}" alt="" class="avatar avatar-md rounded-circle" />
                                            <div class="ms-4">
                                                <p class="mb-1">
                                ...
                                <li class="list-group-item px-5 py-4 list-group-item-action">
                                    <a href="#!" class="text-muted">
                                        <div class="d-flex">
                                            <img src="{{ asset('frontend/images/avatar/avatar-5.jpg') }}" alt="" class="avatar avatar-md rounded-circle" />
                                            <div class="ms-4">
                                                <p class="mb-1">
                                ...
                                <li class="list-group-item px-5 py-4 list-group-item-action">
                                    <a href="#!" class="text-muted">
                                        <div class="d-flex">
                                            <img src="{{ asset('frontend/images/avatar/avatar-2.jpg') }}" alt="" class="avatar avatar-md rounded-circle" />
                                            <div class="ms-4">
                                                <p class="mb-1">
