    ...
    <div class="container">
        <div class="offcanvas offcanvas-start" tabindex="-1" id="navbar-default"
            ...
            <div class="offcanvas-header pb-1">
                <a href="./index.html">
                    <img src="{{asset('frontend/images/logo/freshcart-logo.svg')}}"
                ...
                <div>
                    <ul class="navbar-nav align-items-center">
                        <li class="nav-item w-100 w-lg-auto" style="min-width: 80px;">
                            <a class="nav-link text-md-center" wire:navigate href="{{route('welcome')}}">Home</a>
                        </li>
                        <li class="nav-item w-100 w-lg-auto" style="min-width: 80px;">
                        ...
                        <li class="nav-item dropdown w-100 w-lg-auto" style="min-width: 80px;">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" wire:navigate href="{{route('orders')}}">Orders</a></li>
                                <li><a class="dropdown-item" wire:navigate href="{{route('addresses')}}">Addresses</a></li>
                                <li><a class="dropdown-item" wire:navigate href="{{route('followings')}}">Followings</a></li>
...
@push('styles')
<style>
    /* Override dropdown menu height styling */
    ...
    .dropdown-menu-list-submenu ul.list-unstyled {
        height: auto !important;
        max-height: none !important;
        overflow: visible !important;
    }
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Fix dropdown menu height with JavaScript
        const dropdownItems = document.querySelectorAll('.dropdown-menu-list');

        dropdownItems.forEach(item => {
            // When mouse enters dropdown item
            item.addEventListener('mouseenter', function() {
                const submenu = this.querySelector('.dropdown-menu-list-submenu');
                if (submenu) {
                    // Reset any height/overflow restrictions
                    submenu.style.height = 'auto';
                    submenu.style.maxHeight = 'none';
                    submenu.style.overflow = 'visible';

                    // Get all list elements and reset their heights too
                    const lists = submenu.querySelectorAll('ul');
                    lists.forEach(list => {
