    ...
    <div class="row mb-8">
        <div class="col-md-12">
            ...
            <div
                ...
                style="background-image: url({{ asset('frontend/images/slider/slider-image-1.jpg') }}); background-repeat: no-repeat; background-size: cover; background-position: right">
