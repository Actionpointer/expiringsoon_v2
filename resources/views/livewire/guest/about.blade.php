                    ...
                    <div class="row align-items-center mb-14">
                        <div class="col-md-6">
                            ...
                            <div class="ms-xxl-14 me-xxl-15 mb-8 mb-md-0 text-center text-md-start">
                                ...
                                <p class="mb-0 lead">By powering the future of grocery with our retail partners, we
                                    give everyone access to the food they love and more time to enjoy it together.
                                </p>
                            </div>
                        </div>
                        <!-- col -->
                            ...
                            <div class="card bg-light mb-6 border-0">
                                ...
                                <div class="card-body p-8">
                                    ...
                                    <p>Duis placerat, urna ut dictum lobortis, erat libero feugiat nulla,
                                        ullamcorper fermentum lectus dolor ut tortor.</p>
                                    <!-- btn -->
