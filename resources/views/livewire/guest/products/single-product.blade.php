                ...
                <div class="col-md-5 col-xl-6">
                    ...
                    <div class="product" id="product">
                        <div class="zoom" onmousemove="zoom(event)"
                            style="background-image: url({{asset('frontend/images/products/product-single-img-1.jpg')}})">
                            <!-- img -->
                            <!-- img -->
                        ...
                        <div>
                            <div class="zoom" onmousemove="zoom(event)"
                                style="background-image: url({{asset('frontend/images/products/product-single-img-2.jpg')}})">
                                <!-- img -->
                        ...
                        <div>
                            <div class="zoom" onmousemove="zoom(event)"
                                style="background-image: url({{asset('frontend/images/products/product-single-img-3.jpg')}})">
                                <!-- img -->
                        ...
                        <div>
                            <div class="zoom" onmousemove="zoom(event)"
                                style="background-image: url({{asset('frontend/images/products/product-single-img-4.jpg')}})">
                                <!-- img -->
                            ...
                            <div class="my-8">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">Image shown is a representation and may slightly vary from the
                                        actual product. Every effort is made to maintain accuracy of all information
                                        displayed.</p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="mb-10">
                                            ...
                                            <div class="d-flex border-bottom pb-6 mb-6">
                                                <!-- img -->
                                                <!-- img -->
                                                <img src="{{asset('frontend/images/avatar/avatar-10.jpg')}}" alt=""
                                            ...
                                            <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                                                <!-- img -->
                                                <img src="{{asset('frontend/images/avatar/avatar-12.jpg')}}" alt=""
                                                    class="rounded-circle avatar-lg" />
                                                <div class="ms-5">
                                            ...
                                            <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                                                <!-- img -->
                                                <img src="{{asset('frontend/images/avatar/avatar-9.jpg')}}" alt=""
                                                    class="rounded-circle avatar-lg" />
                                                <div class="ms-5">
                                            ...
                                            <div class="d-flex border-bottom pb-6 mb-6 pt-4">
                                                <!-- img -->
                                                <img src="{{asset('frontend/images/avatar/avatar-8.jpg')}}" alt=""
                                                    class="rounded-circle avatar-lg" />
...
@endpush
@push('scripts')
	<script src="{{asset('frontend/libs/rater-js/index.js')}}"></script>
