                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-header d-sm-flex justify-content-sm-between align-items-sm-center pb-0">
                            <h5 class="card-header-title">Revenues</h5>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless table-thead-bordered table-nowrap table-align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$revenue->created_at->format('jS M,Y h:i A')}}</td>
                                    <td>{{$revenue->description}} </td>
                                    <td>{{ $revenue->currency }} {{$revenue->amount}}</td>
...
<div class="modal fade" id="revenueModal" tabindex="-1" aria-labelledby="revenueModalLabel" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <!-- Header -->
            <div class="modal-header">
                <h4 class="modal-title" id="revenueModalLabel">Create revenue</h4>
            ...
            <div class="modal-body">
                <form action="" method="post">@csrf
                    ...
                    <fieldset>
                        ...
                        <label for="instruction" class="mb-5">The revenue code will be auto-generated after you save </label>
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="">Threshold to avail revenue (optional)</small>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="">If left empty, revenue will run indefinitely</small>
