                            ...
                            <div class="header__cart-item">
                                <div class="header__cart-item-content">
                                    <button class="cart-bag">
                                        ...
                                        <span class="item-number cart-counter">{{count((array) session('cart'))}}</span>
                                    </button>
                                    <div class="header__cart-item-content-info">
                                        <h5>Shopping cart:</h5>
                                        <span class="price">N<span class="cart-ttl-amount">{{number_format($total,2)}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="shopping-cart">
        		<div class="shopping-cart-top">
                    <div class="shopping-cart-header">
                        <h5 class="font-body--xxl-500">Shopping Cart (<span class="count cart-ttl">{{count((array) session('cart'))}}</span>)</h5>
                        <button class="close">
                            ...
                            <div class="shopping-cart__product-content cartitem">
                                <div class="shopping-cart__product-content-item">
                                    ...
                                    <div class="text-content">
                                        ...
                                        <p class="font-body--md-400">{{$cart['quantity']}} x <span class="font-body--md-500">N{{number_format($cart['product']->amount, 2)}}</span></p>
                                    </div>
                                </div>
                    ...
                    <div class="shopping-cart-bottom">
                        <div class="shopping-cart-product-info">
                            ...
                            <span class="product-price font-body--lg-500">N<span class="cart-ttl-amount">{{number_format($total,2)}}</span></span>
                        </div>

                                <!-- <button class="button button--lg w-100" onclick="window.location.href='checkout.php'">Checkout</button> -->
                        <a class="button button--lg w-100" href="{{route('cart')}}">Go to Cart</a>
                    </div>
                </div>
