            ...
            <div class="single-blog__product-content">
                ...
                <div class="single-blog--tag-info">
                    <div class="single-blog--tag-item">
                      <span class="icon">
                        <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M17.1584 11.6753L11.1834 17.6503C11.0286 17.8053 10.8448 17.9282 10.6425 18.0121C10.4402 18.096 10.2233 18.1391 10.0042 18.1391C9.78522 18.1391 9.56834 18.096 9.36601 18.0121C9.16368 17.9282 8.97987 17.8053 8.82508 17.6503L1.66675 10.5003V2.16699H10.0001L17.1584 9.32533C17.4688 9.6376 17.6431 10.06 17.6431 10.5003C17.6431 10.9406 17.4688 11.3631 17.1584 11.6753V11.6753Z" stroke="#00B307" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path>
                          <path d="M5.8335 6.33398H5.84183" stroke="#00B307" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg>
                      </span>
                      <p>Food</p>
                    </div>
                    <div class="single-blog--tag-item">
                      <span class="icon">
                        <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M9.99984 9.66667C11.8408 9.66667 13.3332 8.17428 13.3332 6.33333C13.3332 4.49238 11.8408 3 9.99984 3C8.15889 3 6.6665 4.49238 6.6665 6.33333C6.6665 8.17428 8.15889 9.66667 9.99984 9.66667Z" stroke="#00B307" stroke-width="1.2"></path>
                          <path d="M12.4999 12.167H7.49995C5.19828 12.167 3.13745 14.292 4.65161 16.0245C5.68161 17.2028 7.38495 18.0003 9.99995 18.0003C12.6149 18.0003 14.3174 17.2028 15.3474 16.0245C16.8624 14.2912 14.8008 12.167 12.4999 12.167Z" stroke="#00B307" stroke-width="1.2"></path>
                        </svg>
                      </span>
              ...
              <div class="single-blog__inner-content pt-3">
                
                <p class="feature font-body--md-100">
                ...
                <div class="single-blog--sm-img">
                  <div class="single-blog__img-wrapper two">
                    <img src="{{asset('src/images/blogs/img-02.png')}}" alt="sm-img ">
                  </div>
                  <div class="single-blog__img-wrapper three">
                    <img src="{{asset('src/images/blogs/img-03.png')}}" alt="sm-img ">
                  </div>
                </div>
                <p class="feature">
                  Mauris pretium elit a dui pulvinar, in ornare sapien euismod.
