                        ...
                        <tbody>                     
                            @forelse($user->shops as $shop)        
                                <tr>
                                    ...
                                    <!-- Site Split  -->
                                    <td class="dashboard__order-history-table-item order-total"> 
                                        <p class="order-total-price">   {!!$user->country->currency->symbol!!}{{number_format($shop->orders->sum('total'), 0)}} </p>
                                    </td>
                                    <!-- Status -->
                                    <td class="dashboard__order-history-table-item   order-status "> {!!$user->country->currency->symbol!!} {{number_format($shop->settlements->sum('amount'),2)}}</td>
                                    <td class="dashboard__order-history-table-item   order-status "> {!!$user->country->currency->symbol!!} {{number_format($shop->wallet,2)}}</td>
                                    <!-- Details page  -->
