              ...
              <div class="col-lg-7">
                <div class="dashboard__user-profile dashboard-card">
                  <div class="dashboard__user-profile-img">
                    <img src="{{asset('images/site/avatar.png')}}" alt="{{$user->name}}" />
                  </div>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td colspan="6">
                          <div style="margin:auto;padding:1%;text-align:center;margin-bottom:5%">
                            <img style="padding:10px;width:100px" src="{{asset('images/site/exclamation.png')}}"><br />You have no orders at this time.
                          </div>
                        </td>
                      </tr>
