                    ...
                    <div class="header__cart">
                        ...
                        <div class="header__cart-item">
                            <div class="header__cart-item-content">
                                ...
                                <a href="{{route('notifications')}}" class="wish-bag">
                                    ...
                                    <span class="item-number cart-counter">{{auth()->user()->unreadNotifications->count()}} </span>
                                </a>
                                <a href="{{route('profile')}}" class="wish-bag">
                    ...
                    <div class="col-md-4">
                        <div class="footer__brand-info">
                            <div class="footer__brand-info-logo">
                                <a href="{{route('index')}}"> <img src="{{asset('images/logo-nl-white.png')}}" alt="logo" /></a>
                            </div>
