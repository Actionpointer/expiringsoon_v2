...
<head>
   ...
   <title>Homepage v5 - Modern Design eCommerce HTML Template - FreshCart</title>
   <link href="{{asset('frontend/libs/tiny-slider/dist/tiny-slider.css')}}" rel="stylesheet" />
   <link href="{{asset('frontend/libs/slick-carousel/slick/slick.css')}}" rel="stylesheet" />
   <link href="{{asset('frontend/libs/slick-carousel/slick/slick-theme.css')}}" rel="stylesheet" />
   <!-- Favicon icon-->
...
<body>
      ...
      <div class="container">
         ...
         <div class="row align-items-center pt-6 pb-4 mt-4 mt-lg-0">
            <div class="col-xl-2 col-md-3 mb-4 mb-md-0 col-12 text-center text-md-start">
               <a href="../index.html"><img src="{{asset('frontend/images/logo/freshcart-logo.svg')}}"
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg">
                           <li class="dropdown-menu-list">
                              <a href="javascript:void(0)"
                                 ...
                                 <div>
                                    <svg width="24" height="24" viewBox="0 0 56 56" fill="#3d4f58"
                              ...
                              <div class="dropdown-menu-list-submenu">
                                 <div>
                                    <ul class="list-unstyled">
                                       ...
                                       <li>
                                          <a href="javascript:void(0)" class="dropdown-item">Organic Fruits &amp;
                                             Vegetables</a>
                                       </li>
                                       <li>
                                       ...
                                       <li>
                                          <a href="javascript:void(0)" class="dropdown-item">Exotic Fruits &amp;
                                             Veggies</a>
                                       </li>
                                       <li>
                                          <a href="javascript:void(0)" class="dropdown-item">Flower Bouquets,
                                             Bunches</a>
                                       </li>
                                       <li>
                                 ...
                                 <div>
                                    <ul class="list-unstyled">
                                       ...
                                       <li>
                                          <a href="javascript:void(0)" class="dropdown-item">Apples &amp;
                                             Pomegranate</a>
                                       </li>
                                       <li>
                              ...
                              <div class="dropdown-menu-list-submenu">
                                 ...
                                 <div>
                                    <ul class="list-unstyled">
                                       ...
                                       <li>
                                          <a href="javascript:void(0)" class="dropdown-item">Glucose &amp; Milk
                                             Biscuits</a>
                                       </li>
                                       <li>
                                          <a href="javascript:void(0)" class="dropdown-item">Glucose &amp; Milk
                              ...
                              <div class="dropdown-menu-list-submenu">
                                 <div>
                                    <ul class="list-unstyled">
                                       ...
                                       <li>
                                          <a href="javascript:void(0)" class="dropdown-item">Concentrates &amp;
                                             Syrups</a>
                                       </li>
                                       <li>
                                          <a href="javascript:void(0)" class="dropdown-item">Detox &amp; Energy
                                             Drinks</a>
                                       </li>
                                    </ul>
                                 </div>
                              ...
                              <div class="dropdown-menu-list-submenu">
                                 <div>
                                    <ul class="list-unstyled">
                                       ...
                                       <li>
                                          <a href="javascript:void(0)" class="dropdown-item">Sausage, Salami &amp;
                                             Ham</a>
                                       </li>
                                       <li>
                           ...
                           <li class="dropdown-menu-list">
                              <a href="javascript:void(0)"
                                 class="dropdown-item d-flex justify-content-between mb-1 py-1">
                                 <div>
                                    <svg width="24" height="24" fill="#3d4f58" viewBox="0 0 56 56"
                                       xmlns="http://www.w3.org/2000/svg">
                                       <path
                              ...
                              <div class="dropdown-menu-list-submenu">
                                 <div>
                                    <ul class="list-unstyled">
                                       <li>
                                          <a href="javascript:void(0)" class="dropdown-item">Diapers, Wipes &amp;
                                             More</a>
                                       </li>
                                       <li>
                                       ...
                                       <li>
                                          <a href="javascript:void(0)" class="dropdown-item">Feeding Accessories
                                             Online</a>
                                       </li>
                                       <li>
                           ...
                           <div class="row p-2 p-lg-4">
                              ...
                              <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                                 <div class="card border-0">
                                    <img src="{{asset('frontend/images/banner/menu-banner.jpg')}}" alt="eCommerce HTML Template"
                                       class="img-fluid" />
                        ...
                        <ul class="dropdown-menu">
                           ...
                           <li class="dropdown-submenu dropend">
                              ...
                              <ul class="dropdown-menu">
                                 ...
                                 <li><a class="dropdown-item" href="../pages/account-notification.html">Notification</a>
                                 </li>
                              </ul>
                           </li>
                        </ul>
      ...
      <section class="mt-8">
         <div class="container">
            <div class="hero-slider">
               <div
                  style="background: url({{asset('frontend/images/slider/hero-img-slider-1.jpg')}}) no-repeat; background-size: cover; border-radius: 0.5rem; background-position: center">
                  <div class="ps-lg-12 py-lg-16 col-xxl-5 col-lg-7 col-md-8 py-14 px-8 text-xs-center">
                     ...
                     <p class="lead text-white">Introduced a new model for online grocery shopping and convenient home
               ...
               <div
                  style="background: url({{asset('frontend/images/slider/hero-img-slider-2.jpg')}}) no-repeat; background-size: cover; border-radius: 0.5rem; background-position: center">
                  <div class="ps-lg-12 py-lg-16 col-xxl-5 col-lg-7 col-md-8 py-14 px-8 text-xs-center">
                     ...
                     <p class="lead">Snack on late-night munchies of delicious nuts & you’re guaranteed happiness before
                        you doze!</p>
                     <a href="#!" class="btn btn-dark mt-3">
                        Shop Now
                        <i class="feather-icon icon-arrow-right ms-1"></i>
               ...
               <div
                  style="background: url({{asset('frontend/images/slider/hero-img-slider-3.jpg')}}) no-repeat; background-size: cover; border-radius: 0.5rem; background-position: center">
                  <div class="ps-lg-12 py-lg-16 col-xxl-5 col-lg-7 col-md-8 py-14 px-8 text-xs-center">
         ...
         <div class="container">
            ...
            <div class="row">
                           ...
                           <div class="offcanvas-body p-lg-0">
                                             ...
                                             <div>
                                                ...
                                                <ul class="nav flex-column ms-8">
                                                   ...
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Milk</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Milk Drinks</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Curd & Yogurt</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Eggs</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Bread</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Buns & Bakery</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Butter & More</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Cheese</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Paneer & Tofu</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Cream & Whitener</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Condensed Milk</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Vegan Drinks</a></li>
                                                </ul>
                                             </div>
                                          </div>
                                       </li>
                                          ...
                                          <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                             ...
                                             <div>
                                                <ul class="nav flex-column ms-8">
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Chips & Crisps</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                   ...
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Cakes & Rolls</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Energy Bars</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Papad & Fryums</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Rusks & Wafers</a></li>
                                                </ul>
                                             </div>
                                          </div>
                                       </li>
                                                ...
                                                <ul class="nav flex-column ms-8">
                                                   ...
                                                   <li class="nav-item">
                                                      <a class="nav-link active" aria-current="page"
                                                         href="javascript:void(0)">Fresh Vegetables</a>
                                                   </li>
                                                   <!-- nav item -->
                                                   <li class="nav-item">
                                                      <a class="nav-link" href="javascript:void(0)">Herbs &
                                                         Seasonings</a>
                                                   </li>
                                                   <!-- nav item -->
                                                   <li class="nav-item">
                                                   ...
                                                   <!-- nav item -->
                                                   <li class="nav-item">
                                                      <a class="nav-link" href="javascript:void(0)">Organic Fruits &
                                                         Vegetables</a>
                                                   </li>
                                                   <!-- nav item -->
                                                   <li class="nav-item">
                                                   ...
                                                   <!-- nav item -->
                                                   <li class="nav-item">
                                                      <a class="nav-link" href="javascript:void(0)">Exotic Fruits &
                                                         Veggies</a>
                                                   </li>
                                                   <!-- nav item -->
                                                   <li class="nav-item">
                                                      <a class="nav-link" href="javascript:void(0)">Flower Bouquets,
                                                         Bunches</a>
                                                   </li>
                                                </ul>
                                             </div>
                                          ...
                                          <div id="flush-collapseFour" class="accordion-collapse collapse"
                                             ...
                                             <div>
                                                <ul class="nav flex-column ms-8">
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Soft Drinks</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Fruit Juices</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                   ...
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Water & Ice Cubes</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Soda & Mixers</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Concentrates & Syrups</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Detox & Energy Drinks</a></li>
                                                   <!-- nav item -->
                                                   <li class="nav-item"><a href="javascript:void(0)"
                                                         class="nav-link">Juice Collection</a></li>
                                                </ul>
                                             </div>
                                          </div>
                                       </li>
                                          ...
                                          <div id="flush-collapseFive" class="accordion-collapse collapse"
                                             ...
                                             <div>
                                                <ul class="nav flex-column ms-8">
                                                   ...
                                                   <li class="nav-item">
                                                      <a class="nav-link active" aria-current="page"
                                                         href="javascript:void(0)">Diapers, Wipes & More</a>
                                                   </li>
                                                   <!-- nav item -->
                                                   <li class="nav-item">
                                                   ...
                                                   <!-- nav item -->
                                                   <li class="nav-item">
                                                      <a class="nav-link" href="javascript:void(0)">Oral & Nasal
                                                         Care</a>
                                                   </li>
                                                   <!-- nav item -->
                                                   <li class="nav-item">
                                                      <a class="nav-link" href="javascript:void(0)">Baby Skin Care
                                                         Online</a>
                                                   </li>
                                                   <!-- nav item -->
                                                   <li class="nav-item">
                                                      <a class="nav-link" href="javascript:void(0)">Cleaning Needs
                                                         Online</a>
                                                   </li>
                                                   <!-- nav item -->
                                                   <li class="nav-item">
                                                      <a class="nav-link" href="javascript:void(0)">Feeding Accessories
                                                         Online</a>
                                                   </li>
                                                </ul>
                                             </div>
                                          ...
                                          <div id="flush-collapseSix" class="accordion-collapse collapse"
                                             ...
                                             <div>
                                                <ul class="nav flex-column ms-8">
                                                   ...
                                                   <!-- nav item -->
                                                   <li class="nav-item">
                                                      <a class="nav-link" href="javascript:void(0)">Healthy &
                                                         Digestive</a>
                                                   </li>
                                                   <!-- nav item -->
                                                   <li class="nav-item">
                                          ...
                                          <div id="flush-collapseSeven" class="accordion-collapse collapse"
                                             ...
                                             <div>
                                                <ul class="nav flex-column ms-8">
                                                   ...
                                                   <!-- nav item -->
                                                   <li class="nav-item">
                                                      <a class="nav-link" href="javascript:void(0)">Sausage, Salami &
                                                         Ham</a>
                                                   </li>
                                                   <!-- nav item -->
                                                   <li class="nav-item">
                                                   ...
                                                   <!-- nav item -->
                                                   <li class="nav-item">
                                                      <a class="nav-link" href="javascript:void(0)">Frozen Non-Veg
                                                         Snacks</a>
                                                   </li>
                                                </ul>
                                             </div>
                              ...
                              <div class="card mb-6">
                                 ...
                                 <div class="card-body d-flex align-items-center border-top">
                                    ...
                                    <div class="ms-3">
                                       <p class="mb-0 small">Return Policy customers can return a product and ask for a
                                          refund.</p>
                                    </div>
                                 </div>
                                 <div class="card-body d-flex align-items-center border-top">
                              ...
                              <div class="mb-8">
                                 ...
                                 <div class="card bg-light-warning border-0">
                                    <div class="card-body p-5">
                                       ...
                                       <p>Lorem ipsum dolor sit amet, consectetur adipis cing elit. Curabitur iaculis
                                          maximus purus, a gravida dui tempor eget.</p>
                                       <div class="d-flex align-items-center">
                                          <div>
                                             <img src="{{asset('frontend/images/avatar/avatar-1.jpg')}}" alt=""
               ...
               <div class="col-xl-9 col-lg-8 col-md-12 mb-6 mb-md-0">
                     ...
                     <div class="product-slider-four-column">
                        ...
                        <div class="item">
                           ...
                           <div class="card card-product mb-4">
                              <div class="card-body text-center py-8">
                                 <!-- img -->
                                 <a href="#"><img src="{{asset('frontend/images/category/category-snack-munchies.jpg')}}"
                        ...
                        <div class="item">
                           ...
                           <div class="card card-product mb-4">
                              <div class="card-body text-center py-8">
                                 <!-- img -->
                                 <a href="#"><img src="{{asset('frontend/images/category/category-dairy-bread-eggs.jpg')}}"
                                       alt="Grocery Ecommerce Template" class="mb-3" /></a>
                                 <!-- text -->
                              </div>
                           </div>
                        ...
                        <div class="item">
                           ...
                           <div class="card card-product mb-4">
                              <div class="card-body text-center py-8">
                                 <!-- img -->
                                 <a href="#"><img src="{{asset('frontend/images/category/category-tea-coffee-drinks.jpg')}}"
                                       alt="Grocery Ecommerce Template" class="mb-3" /></a>
                                 <!-- text -->
                              </div>
                           </div>
                        ...
                        <div class="item">
                           ...
                           <div class="card card-product mb-4">
                              <div class="card-body text-center py-8">
                                 <!-- img -->
                                 <a href="#"><img src="{{asset('frontend/images/category/category-bakery-biscuits.jpg')}}"
                                       alt="Grocery Ecommerce Template" class="mb-3" /></a>
                                 <!-- text -->
                              </div>
                           </div>
                        ...
                        <div class="item">
                           ...
                           <div class="card card-product mb-4">
                              <div class="card-body text-center py-8">
                                 <!-- img -->
                                 <a href="#"><img src="{{asset('frontend/images/category/category-atta-rice-dal.jpg')}}"
                                       alt="Grocery Ecommerce Template" class="mb-3" /></a>
                                 <!-- text -->
                              </div>
                           </div>
                        ...
                        <div class="item">
                           ...
                           <div class="card card-product mb-4">
                              <div class="card-body text-center py-8">
                                 <!-- img -->
                                 <a href="#"><img src="{{asset('frontend/images/category/category-chicken-meat-fish.jpg')}}"
                                       alt="Grocery Ecommerce Template" class="mb-3" /></a>
                                 <!-- text -->
                              </div>
                           </div>
                        ...
                        <div class="item">
                           ...
                           <div class="card card-product mb-4">
                              <div class="card-body text-center py-8">
                                 <!-- img -->
                                 <a href="#"><img src="{{asset('frontend/images/category/category-cleaning-essentials.jpg')}}"
                                       alt="Grocery Ecommerce Template" class="mb-3" /></a>
                                 <!-- text -->
                              </div>
                           </div>
                     ...
                     <div class="card border border-danger p-6">
                        <div class="row">
                           <div class="col-lg-5 text-center">
                              <a href="./pages/shop-single.html"><img src="{{asset('frontend/images/products/deal-img.jpg')}}"
                           ...
                           <div class="col-lg-7 text-center text-lg-start">
                              ...
                              <h2 class="fs-4"><a href="./pages/shop-single.html"
                                    class="text-inherit text-decoration-none">Parle Platina Nutricrunch Digestive
                                    Cookies</a></h2>
                              ...
                              <div class="mt-6 mb-6">
                                 ...
                                 <div class="progress bg-light-danger" role="progressbar" aria-label="Example 1px high"
                                    aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="height: 5px">
                  ...
                  <div
                     class="bg-light-danger text-danger p-4 rounded bg-opacity-50 text-center mb-12 d-flex align-items-center justify-content-center">
                     <p class="mb-0">
                        First time here? Get 10% off your first order!
                        <span class="link-danger link-underline-danger">Click here</span>
                     </p>
                     <span
                        class="border-dashed border-danger py-1 px-3 text-danger rounded bg-light-danger ms-4">FIRSTTIME10</span>
                  </div>
                  <div class="row">
                     <div class="col-12">
                        ...
                        <div class="row row-cols-xl-4 row-cols-lg-3 g-4">
                           <div class="col">
                              <div class="mb-6">
                                 <div class="card card-product mb-4">
                                    <div class="card-body text-center py-8">
                                       <!-- img -->
                                       <a href="#"><img src="{{asset('frontend/images/category/category-instant-food.jpg')}}"
                                             alt="Grocery Ecommerce Template" class="mb-3" /></a>
                                       <!-- text -->
                                    </div>
                                 </div>
                           ...
                           <div class="col">
                              <div class="mb-6">
                                 ...
                                 <div class="card card-product mb-4">
                                    <div class="card-body text-center py-8">
                                       <!-- img -->
                                       <a href="#"><img src="{{asset('frontend/images/category/category-baby-care.jpg')}}"
                                             alt="Grocery Ecommerce Template" class="mb-3" /></a>
                                       <!-- text -->
                                    </div>
                                 </div>
                           ...
                           <div class="col">
                              <div class="mb-6">
                                 ...
                                 <div class="card card-product mb-4">
                                    <div class="card-body text-center py-8">
                                       <!-- img -->
                                       <a href="#"><img src="{{asset('frontend/images/category/category-pet-care.jpg')}}"
                                             alt="Grocery Ecommerce Template" class="mb-3" /></a>
                                       <!-- text -->
                                    </div>
                                 </div>
                           ...
                           <div class="col">
                              <div class="mb-6">
                                 ...
                                 <div>
                                    <span class="badge bg-danger rounded-pill">-45%</span>
                                    <h2 class="mt-3 fs-6"><a href="#" class="text-inherit">Salted Instant Popcorn</a>
                                    </h2>
                                    <div>
                                       <span class="text-dark fs-5 fw-bold">$18</span>
                                       <span class="text-decoration-line-through text-muted">$24</span>
                  ...
                  <div class="col-12 col-md-6 col-lg-3 mb-8">
                     <div class="mb-4">
                        <a href="javascript:void(0)">
                           <!-- img -->
                           <div class="img-zoom">
                              <img src="{{asset('frontend/images/blog/blog-img-1.jpg')}}" alt="" class="img-fluid rounded w-100" />
                           </div>
                        </a>
                     </div>
                     <!-- text -->
                  ...
                  <div class="col-12 col-md-6 col-lg-3 mb-8">
                     <div class="mb-4">
                        <a href="javascript:void(0)">
                           <div class="img-zoom">
                              <!-- img -->
                              <img src="{{asset('frontend/images/blog/blog-img-2.jpg')}}" alt="" class="img-fluid rounded w-100" />
                           </div>
                        </a>
                     </div>
                     <!-- text -->
                     <div>
                        <h4 class="h5"><a href="javascript:void(0)" class="text-inherit">Almond Butter Chocolate Chip
                              Zucchini Bars</a></h4>
                  ...
                  <div class="col-12 col-md-6 col-lg-3 mb-8">
                     <div class="mb-4">
                        <a href="javascript:void(0)">
                           <!-- img -->
                           <div class="img-zoom">
                              <img src="{{asset('frontend/images/blog/blog-img-3.jpg')}}" alt="" class="img-fluid rounded w-100" />
                           </div>
                        </a>
                     </div>
                     <!-- text -->
                     <div>
                        <h4 class="h5"><a href="javascript:void(0)" class="text-inherit">Spicy Shrimp Tacos Garlic
                  ...
                  <div class="col-12 col-md-6 col-lg-3 mb-8">
                     <div class="mb-4">
                        <a href="javascript:void(0)">
                           <!-- img -->
                           <div class="img-zoom">
                              <img src="{{asset('frontend/images/blog/blog-img-4.jpg')}}" alt="" class="img-fluid rounded w-100" />
                           </div>
                        </a>
                     </div>
                     <div>
                        <h4 class="h5"><a href="javascript:void(0)" class="text-inherit">Simple Homemade Tomato Soup</a>
                        </h4>
            ...
            <div class="modal-body p-0">
               <div class="d-flex align-items-center">
                  <div class="d-none d-lg-block">
                     <img src="{{asset('frontend/images/banner/modal_img.jpg')}}" alt="" class="img-fluid rounded-start" />
                  </div>
         ...
         <div class="modal-content">
            <div class="modal-body p-8">
               ...
               <div class="row">
                  ...
                  background-image: url({{asset('frontend/images/products/product-single-img-1.jpg')}});
                ">
                           <!-- img -->
                           <img src="{{asset('frontend/images/products/product-single-img-1.jpg')}}" alt="">
                        </div>
                        <div>
                           <div class="zoom" onmousemove="zoom(event)" style="
                    background-image: url({{asset('frontend/images/products/product-single-img-2.jpg')}});
                  ">
                              <!-- img -->
                              <img src="{{asset('frontend/images/products/product-single-img-2.jpg')}}" alt="">
                           </div>
                        </div>
                        <div>
                           <div class="zoom" onmousemove="zoom(event)" style="
                    background-image: url({{asset('frontend/images/products/product-single-img-3.jpg')}});
                  ">
                              <!-- img -->
                              <img src="{{asset('frontend/images/products/product-single-img-3.jpg')}}" alt="">
                           </div>
                        </div>
                        <div>
                           <div class="zoom" onmousemove="zoom(event)" style="
                    background-image: url({{asset('frontend/images/products/product-single-img-4.jpg')}});
                  ">
                              <!-- img -->
                              <img src="{{asset('frontend/images/products/product-single-img-4.jpg')}}" alt="">
                           </div>
                        </div>
                     </div>
                     <!-- product tools -->
      ...
      <div class="container">
         <div class="row align-items-center">
            <div class="col-8 col-md-12 col-lg-4">
               <a href="#"><img src="{{asset('frontend/images/logo/freshcart-white-logo.svg')}}" alt="" /></a>
            </div>
   ...
   <script src="{{asset('frontend/libs/slick-carousel/slick/slick.min.js')}}"></script>
   <script src="{{asset('frontend/js/vendors/slick-slider.js')}}"></script>
   ...
   <script src="{{asset('frontend/js/vendors/countdown.js')}}"></script>
   <script src="{{asset('frontend/libs/sticky-sidebar/dist/sticky-sidebar.min.js')}}"></script>
   <script src="{{asset('frontend/js/vendors/sticky.js')}}"></script>
   <script src="{{asset('frontend/js/vendors/modal.js')}}"></script>
</body>
