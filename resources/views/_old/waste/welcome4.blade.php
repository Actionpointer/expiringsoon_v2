...
<body>
				...
				<div class="col-xl-7 col-lg-8">
					<div class="d-flex align-items-center">
						<a class="navbar-brand d-none d-lg-block" href="../index.html">
							<img src="{{asset('frontend/images/logo/freshcart-logo.svg')}}" alt="eCommerce HTML Template" />
						</a>
										...
										<div class="dropdown-menu-list-submenu">
											<div>
												<ul class="list-unstyled">
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Fresh
															Vegetables</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Herbs &amp;
															Seasonings</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Fresh
													...
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Organic
															Fruits &amp; Vegetables</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Cuts &amp;
															Sprouts</a>
													</li>
													<li>
													...
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Flower
															Bouquets, Bunches</a>
													</li>
													<li>
											...
											<div>
												<ul class="list-unstyled">
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Banana &amp;
															Papaya</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Kiwi, Citrus
															Fruit</a>
													</li>
													<li>
													...
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Seasonal
															Fruits</a>
													</li>
													<li>
													...
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Fruit
															Baskets</a>
													</li>
												</ul>
											</div>
									...
									<li class="dropdown-menu-list">
										...
										<div class="dropdown-menu-list-submenu">
											<div>
												<ul class="list-unstyled">
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Chips &amp;
															Crisps</a>
													</li>
													<li>
													...
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Bhujia &amp;
															Mixtures</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Namkeen
															Snacks</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Healthy
															Snacks</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Cakes &amp;
															Rolls</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Energy
															Bars</a>
													</li>
												</ul>
											</div>
											...
											<div>
												<ul class="list-unstyled">
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Papad &amp;
															Fryums</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Glucose &amp;
															Milk Biscuits</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Glucose &amp;
										...
										<div class="dropdown-menu-list-submenu">
											<div>
												<ul class="list-unstyled">
													...
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Sweet &amp;
															Salty</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Healthy &amp;
													...
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Cream
															Biscuits</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Rusks &amp;
															Wafers</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Cakes &amp;
													...
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Buns &amp;
															Bakery</a>
													</li>
												</ul>
											</div>
									...
									<li class="dropdown-menu-list">
										...
										<div class="dropdown-menu-list-submenu">
											<div>
												<ul class="list-unstyled">
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Soft
															Drinks</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Fruit
													...
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Water &amp;
															Ice Cubes</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Soda &amp;
															Mixers</a>
													</li>
													<li>
													...
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Detox &amp;
															Energy Drinks</a>
													</li>
												</ul>
											</div>
											...
											<div>
												<ul class="list-unstyled">
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Juice
															Collection</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Concentrates
										...
										<div class="dropdown-menu-list-submenu">
											<div>
												<ul class="list-unstyled">
													...
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Milk
															Drinks</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Curd &amp;
															Yogurt</a>
													</li>
													<li>
													...
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Butter &amp;
															More</a>
													</li>
													<li>
											...
											<div>
												<ul class="list-unstyled">
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Paneer &amp;
															Tofu</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Cream &amp;
													...
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Condensed
															Milk</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Vegan
															Drinks</a>
													</li>
												</ul>
											</div>
										...
										<div class="dropdown-menu-list-submenu">
											<div>
												<ul class="list-unstyled">
													...
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Sausage,
															Salami &amp; Ham</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Exotic
															Meat</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Eggs</a>
													...
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Frozen
															Non-Veg Snacks</a>
													</li>
												</ul>
											</div>
									...
									<li class="dropdown-menu-list">
										...
										<div class="dropdown-menu-list-submenu">
											<div>
												<ul class="list-unstyled">
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Diapers,
															Wipes &amp; More</a>
													</li>
													<li>
													...
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Bath &amp;
															Hair Care</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Oral &amp;
															Nasal Care</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Baby Skin
															Care Online</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Cleaning
															Needs Online</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Feeding
															Accessories Online</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Baby
															Pharma</a>
													</li>
												</ul>
											</div>
											...
											<div>
												<ul class="list-unstyled">
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Mother
															Care</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Baby Gift
															Set</a>
													</li>
													<li>
														<a href="javascript:void(0)" class="dropdown-item">Kids Toys
															&amp; More</a>
													</li>
												</ul>
											</div>
									...
									<div class="row p-2 p-lg-4">
										...
										<div class="col-lg-3 col-12 mb-4 mb-lg-0">
											<div class="card border-0">
												<img src="{{asset('frontend/images/banner/menu-banner.jpg')}}"
							...
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li class="dropdown-submenu dropend">
										<a class="dropdown-item dropdown-list-group-item dropdown-toggle" href="#">My
											Account</a>
										<ul class="dropdown-menu">
			...
			<div class="modal-content">
				<div class="modal-body">
					...
					<div class="my-10 text-center">
						<img src="{{asset('frontend/images/svg-graphics/delivery-boy.svg')}}" alt="" class="img-fluid" />
					</div>
				</div>
			</div>
		</div>
	...
	<main>
		...
		<section class="py-lg-16 py-10"
			style="background: url({{asset('frontend/images/banner/banner-4.jpg')}}) no-repeat; background-position: center; background-size: cover">
			<div class="container">
				<!-- row -->
				<div class="row">
				...
				<div class="category-slider">
						...
						<a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
							<div class="card card-product mb-lg-4">
								<div class="card-body text-center py-8">
									<img src="{{asset('frontend/images/category/category-dairy-bread-eggs.jpg')}}"
					...
					<div class="item">
						<a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
							<div class="card card-product mb-lg-4">
								<div class="card-body text-center py-8">
									<img src="{{asset('frontend/images/category/category-snack-munchies.jpg')}}"
					...
					<div class="item">
						<a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
							<div class="card card-product mb-lg-4">
								<div class="card-body text-center py-8">
									<img src="{{asset('frontend/images/category/category-bakery-biscuits.jpg')}}"
										alt="Grocery Ecommerce Template" class="mb-3" />
					...
					<div class="item">
						<a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
							<div class="card card-product mb-lg-4">
								<div class="card-body text-center py-8">
									<img src="{{asset('frontend/images/category/category-instant-food.jpg')}}"
										alt="Grocery Ecommerce Template" class="mb-3" />
					...
					<div class="item">
						<a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
							<div class="card card-product mb-lg-4">
								<div class="card-body text-center py-8">
									<img src="{{asset('frontend/images/category/category-tea-coffee-drinks.jpg')}}"
										alt="Grocery Ecommerce Template" class="mb-3" />
					...
					<div class="item">
						<a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
							<div class="card card-product mb-lg-4">
								<div class="card-body text-center py-8">
									<img src="{{asset('frontend/images/category/category-atta-rice-dal.jpg')}}"
										alt="Grocery Ecommerce Template" class="mb-3" />
					...
					<div class="item">
						<a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
							<div class="card card-product mb-lg-4">
								<div class="card-body text-center py-8">
									<img src="{{asset('frontend/images/category/category-baby-care.jpg')}}"
										alt="Grocery Ecommerce Template" class="mb-3" />
					...
					<div class="item">
						<a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
							<div class="card card-product mb-lg-4">
								<div class="card-body text-center py-8">
									<img src="{{asset('frontend/images/category/category-chicken-meat-fish.jpg')}}"
										alt="Grocery Ecommerce Template" class="mb-3" />
					...
					<div class="item">
						<a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
							<div class="card card-product mb-lg-4">
								<div class="card-body text-center py-8">
									<img src="{{asset('frontend/images/category/category-cleaning-essentials.jpg')}}"
										alt="Grocery Ecommerce Template" class="mb-3" />
					...
					<div class="item">
						<a href="../pages/shop-grid.html" class="text-decoration-none text-inherit">
							<div class="card card-product mb-lg-4">
								<div class="card-body text-center py-8">
									<img src="{{asset('frontend/images/category/category-pet-care.jpg')}}"
										alt="Grocery Ecommerce Template" class="mb-3" />
						...
						<div class="card card-product mb-lg-4">
							<div class="card-body">
								...
								<div class="text-center position-relative">
									...
									<!-- img -->
									<!-- img -->
									<a href="#!"><img src="{{asset('frontend/images/products/product-img-15.jpg')}}"
						...
						<div class="card card-product mb-lg-4">
							<div class="card-body">
								<div class="text-center position-relative">
									...
									<!-- img -->
									<a href="#!"><img src="{{asset('frontend/images/products/product-img-16.jpg')}}"
											alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
									<!-- action btn -->
									<!-- action btn -->
									<div class="card-product-action">
					...
					<div class="item">
						...
						<div class="card card-product mb-lg-4">
							<div class="card-body">
								<div class="text-center position-relative">
									<!-- img -->
									<a href="#!"><img src="{{asset('frontend/images/products/product-img-17.jpg')}}"
											alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
									<!-- action btn -->
									<div class="card-product-action">
										<a href="#!" class="btn-action" data-bs-toggle="modal"
						...
						<div class="card card-product mb-lg-4">
							<div class="card-body">
								<div class="text-center position-relative">
									...
									<!-- img -->
									<a href="#!"><img src="{{asset('frontend/images/products/product-img-18.jpg')}}"
											alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
									<!-- action btn -->
									<div class="card-product-action">
										<a href="#!" class="btn-action" data-bs-toggle="modal"
					...
					<div class="item">
						...
						<div class="card card-product mb-lg-4">
							<div class="card-body">
								<div class="text-center position-relative">
									<!-- img -->
									<a href="#!"><img src="{{asset('frontend/images/products/product-img-19.jpg')}}"
											alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
									<!-- action btn -->
									<div class="card-product-action">
										<a href="#!" class="btn-action" data-bs-toggle="modal"
					...
					<div class="row flex-nowrap">
						<div class="col">
							<div class="card border-0 card-hover">
								<a href="#" class="img-zoom"><img src="{{asset('frontend/images/banner/ad-banner-4.jpg')}}" alt=""
										class="rounded" /></a>
						...
						<div class="col">
							<div class="card border-0">
								<a href="#" class="img-zoom"><img src="{{asset('frontend/images/banner/ad-banner-5.jpg')}}" alt=""
										class="rounded" /></a>
						...
						<div class="col">
							<div class="card border-0">
								<a href="#" class="img-zoom"><img src="{{asset('frontend/images/banner/ad-banner-6.jpg')}}" alt=""
										class="rounded" /></a>
								...
								<div class="card card-product h-100 mb-4">
									<div class="card-body position-relative">
										...
										<div class="text-center position-relative">
											...
											<!-- img -->
											<a href="#!"><img src="{{asset('frontend/images/products/product-img-1.jpg')}}"
													alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
											<!-- action btn -->
							...
							<div class="item">
								...
								<div class="card card-product h-100 mb-4">
									<div class="card-body position-relative">
										...
										<div class="text-center position-relative">
											<!-- img -->
											<a href="#!"><img src="{{asset('frontend/images/products/product-img-8.jpg')}}"
													alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
											<!-- action btn -->
											<div class="product-action-btn">
												<a href="#!" class="btn-action mb-1" data-bs-toggle="modal"
							...
							<div class="item">
								...
								<div class="card card-product h-100 mb-4">
									<div class="card-body position-relative">
										...
										<div class="text-center position-relative">
											<!-- img -->
											<a href="#!"><img src="{{asset('frontend/images/products/product-img-9.jpg')}}"
													alt="Grocery Ecommerce Template" class="mb-3 img-fluid" /></a>
											<!-- action btn -->
											<div class="product-action-btn">
												<a href="#!" class="btn-action mb-1" data-bs-toggle="modal"
				...
				<div class="row row-cols-1 row-cols-lg-3 row-cols-md-3 g-4 g-lg-4">
					...
					<div class="col">
						...
						<div class="card p-6 card-product">
							<div>
								<!-- img -->
								<img src="{{asset('frontend/images/stores-logo/stores-logo-1.svg')}}" alt=""
					...
					<div class="col">
						...
						<div class="card p-6 card-product">
							<div>
								<!-- img -->
								<img src="{{asset('frontend/images/stores-logo/stores-logo-2.svg')}}" alt=""
									class="rounded-circle icon-shape icon-xl" />
							</div>
							<div class="mt-4">
								<!-- content -->
					...
					<div class="col">
						...
						<div class="card p-6 card-product">
							<div>
								<!-- img -->
								<img src="{{asset('frontend/images/stores-logo/stores-logo-3.svg')}}" alt=""
									class="rounded-circle icon-shape icon-xl" />
							</div>
							<div class="mt-4">
								<!-- content -->
					...
					<div class="col-12 col-md-6 col-lg-3 mb-8">
						<div class="mb-4">
							<a href="#!">
								<!-- img -->
								<div class="img-zoom">
									<img src="{{asset('frontend/images/blog/blog-img-1.jpg')}}" alt=""
					...
					<div class="col-12 col-md-6 col-lg-3 mb-8">
						<div class="mb-4">
							<a href="#!">
								<div class="img-zoom">
									<!-- img -->
									<img src="{{asset('frontend/images/blog/blog-img-2.jpg')}}" alt=""
										class="img-fluid rounded w-100" />
								</div>
							</a>
						</div>
					...
					<div class="col-12 col-md-6 col-lg-3 mb-8">
						<div class="mb-4">
							<a href="#!">
								<!-- img -->
								<div class="img-zoom">
									<img src="{{asset('frontend/images/blog/blog-img-3.jpg')}}" alt=""
										class="img-fluid rounded w-100" />
								</div>
							</a>
						</div>
					...
					<div class="col-12 col-md-6 col-lg-3 mb-8">
						<div class="mb-4">
							<a href="#!">
								<!-- img -->
								<div class="img-zoom">
									<img src="{{asset('frontend/images/blog/blog-img-4.jpg')}}" alt=""
										class="img-fluid rounded w-100" />
								</div>
							</a>
						</div>
