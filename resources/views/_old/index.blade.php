	...
	<div class="row mb-8">
		<div class="col-md-12">
			...
			<div class="d-md-flex justify-content-between align-items-center">
				...
				<!-- button -->
				<div>
					<a href="{{ route('store.products.create',1) }}" class="btn btn-primary">Add Product</a>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="table-responsive">
					<table class="table table-centered table-hover text-nowrap table-borderless mb-0 table-with-checkbox">
						...
						<tr>
							...
							<td>
								<a href="#!"><img src="{{asset('frontend/images/products/product-img-1.jpg')}}" alt="" class="icon-shape icon-md" /></a>
							</td>
						...
						<tr>
							...
							<td>
								<a href="#!"><img src="{{asset('frontend/images/products/product-img-2.jpg')}}" alt="" class="icon-shape icon-md" /></a>
							</td>
						...
						<tr>
							...
							<td>
								<a href="#!"><img src="{{asset('frontend/images/products/product-img-3.jpg')}}" alt="" class="icon-shape icon-md" /></a>
							</td>
						...
						<tr>
							...
							<td>
								<a href="#!"><img src="{{asset('frontend/images/products/product-img-4.jpg')}}" alt="" class="icon-shape icon-md" /></a>
							</td>
						...
						<tr>
							...
							<td>
								<a href="#!"><img src="{{asset('frontend/images/products/product-img-5.jpg')}}" alt="" class="icon-shape icon-md" /></a>
							</td>
						...
						<tr>
							...
							<td>
								<a href="#!"><img src="{{asset('frontend/images/products/product-img-6.jpg')}}" alt="" class="icon-shape icon-md" /></a>
							</td>
						...
						<tr>
							...
							<td>
								<a href="#!"><img src="{{asset('frontend/images/products/product-img-7.jpg')}}" alt="" class="icon-shape icon-md" /></a>
							</td>
						...
						<tr>
							...
							<td>
								<a href="#!"><img src="{{asset('frontend/images/products/product-img-8.jpg')}}" alt="" class="icon-shape icon-md" /></a>
							</td>
							<td><a href="#" class="text-reset">Blueberry Greek Yogurt</a></td>
							<td>Instant Food</td>
						...
						<tr>
							...
							<td>
								<a href="#!"><img src="{{asset('frontend/images/products/product-img-9.jpg')}}" alt="" class="icon-shape icon-md" /></a>
							</td>
						...
						<tr>
							...
							<td>
								<a href="#!"><img src="{{asset('frontend/images/products/product-img-10.jpg')}}" alt="" class="icon-shape icon-md" /></a>
							</td>
