                                      ...
                                      <div class="col-lg-5 order-lg-0 order-1">
                                        <div class="dashboard__content-card-img flex-column">
                                            ...
                                            <div class="dashboard__content-img-wrapper" id="avatar">
                                              <img @if(!$shop->banner) src="{{asset('images/site/avatar.png')}}"  @else src="{{Storage::url($shop->banner)}}" @endif alt="{{$shop->fname}} {{$shop->lname}}"  onclick="performClick('theFile');"  id="imgPreview"   />
                                            </div>
                                            <div>
