                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="row banner--04__content">
                            <div class="col-lg-6">
                                <div class="banner--04__img-wrapper">
                                    <img src="{{asset('images/banner/banner-sm-06.png')}}" alt="banner" class="img-fluid">
                                    <div class="off-sale">
                                        <p>
                                            <span>70%</span>
                                            off
                    ...
                    <div class="swiper-slide">
                        <div class="row banner--04__content">
                            <div class="col-lg-6">
                                <div class="banner--04__img-wrapper">
                                    <img src="{{asset('images/banner/banner-sm-12.png')}}" alt="banner" class="img-fluid">
                                    <div class="off-sale">
                                        <p>
                                            <span>70%</span>
                                            off
                ...
                <div class="col-xxl-3 order-xxl-0 order-1">
                    <div class="cards-ss cards-ss--darktext cards-ss--small-two">
                        ...
                        <div class="overlay-img">
                            <img src="{{asset('images/overlay/leaf-06.png')}}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        @if($loop->first)
                            <div class="cards-lg deals-products__wrapper-item deals-products__wrapper-item--one">
                                <div class="cards-lg__img-wrapper">
                                    <img src="{{asset('images/products/img-12.png')}}" alt="products">
                                    <div class="tag-group">
                    ...
                    <div class="row newsletter-popup__content">
                        <div class="col-lg-5">
                            <div class="newsletter-popup__img-wrapper">
                                <img src="{{asset('images/banner/banner-sm-18.png')}}" alt="newsletter" />
                            </div>
                        </div>
                        <div class="col-lg-7">
