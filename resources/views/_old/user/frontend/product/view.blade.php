                                            ...
                                            <div class="products-tab__feedback-content-top">
                                                <div class="user-details">
                                                    <div class="user-details__img">
                                                        <img @if(!$review->user->pic) src="{{asset('images/site/avatar.png')}}"  @else src="{{Storage::url($review->user->pic)}}" @endif alt="user-img">
                                                    </div>
                            ...
                            <div class="cards-md cards-md--four w-100">
                                <div class="cards-md__img-wrapper">
                                    <a href="{{route('product.show',$item)}}">
                                        <img @if(!$item->photo) src='{{asset("images/no-image.png")}}'  @else src="{{$item->image}}" @endif alt="{{$item->product}}" />
                                    </a>
