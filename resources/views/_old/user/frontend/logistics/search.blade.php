        ...
        <div class="col-lg-3">
          <div class="contact-form__contact-info">
            ...
            <div class="contact-form__contact-info--item">
              <span class="icon">
                <svg width="52" height="51" viewBox="0 0 52 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M31.9829 7.24219C34.9249 8.03345 37.6074 9.58385 39.7616 11.7381C41.9159 13.8923 43.4663 16.5748 44.2575 19.5168" stroke="#2C742F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M30.1865 13.9502C31.9513 14.425 33.5604 15.3551 34.8527 16.6474C36.145 17.9396 37.0751 19.5488 37.5499 21.3136" stroke="#2C742F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
