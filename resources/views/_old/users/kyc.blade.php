                                    ...
                                    <td class="dashboard__order-history-table-item order-date">
                                      <div class="d-flex">
                                        @if($document->verifiable_type == 'App\Models\Shop')
                                          <img @if(!$document->verifiable->banner) src="{{asset('images/site/avatar.png')}}" @else src="{{Storage::url($document->verifiable->banner)}}" @endif alt="{{$document->verifiable->name}}" style="width:50px;height:50px;border-radius:50px;border:1px solid #ddd;padding:3px" />
                                        @else
                                          <img @if(!$document->verifiable->photo) src="{{asset('images/site/avatar.png')}}" @else src="{{Storage::url($document->verifiable->photo)}}" @endif alt="{{$document->verifiable->name}}" style="width:50px;height:50px;border-radius:50px;border:1px solid #ddd;padding:3px" />
                                        @endif
                                ...
                                <tr>
                                  <td colspan="5">
                                    <div style="margin:auto;padding:1%;text-align:center;margin-bottom:5%">
                                      <img style="padding:10px;width:100px" src="{{asset('images/site/exclamation.png')}}"><br />No pending KYC at this time.
                                    </div>
                                  </td>
                                </tr>
                            @endforelse
