                    ...
                    <tr>
                        <td class="td container"
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="p30-15 tbrr" style="padding: 30px; border-radius:26px 26px 0px 0px;"
                                        bgcolor="#fff">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="text-header"
                                                                style="color:#fff; font-family:'Playfair Display', Georgia,serif; font-size:13px; line-height:18px; text-align:right;">
                                                                &nbsp;</td>
                                                        </tr>
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div class=""
                                                                                                            ...
                                                                                                            <p
                                                                                                                ...
                                                                                                                <span style="font-size:30px;color:#2b3940;">
																													<strong>
																														<span style="">Here are some featured Products you might be interested in</span>
																													</strong>
																												</span>
                                                                                                            </p>
                                                                                                        </div>
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div class=""
                                                                                                            ...
                                                                                                            <p
                                                                                                                ...
                                                                                                                <span
                                                                                                                    style="color:#7e8989;">Featured by {{$shop->name}} Shop</span>
                                                                                                            </p>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </td>
                                                                        ...
                                                                        <td class="pad">
                                                                            <div align="center" class="alignment"
                                                                                style="line-height:10px"><img
                                                                                    ...
                                                                                    style="height: auto; display: block; border: 0; max-width: 181.33333333333331px; width: 100%;"
                                                                                    title="I'm an image"
                                                                                    width="181.33333333333331"></div>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        ...
                                                        <td class="column column-2"
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="pad"
                                                                            style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:7px;">
                                                                            <div align="center" class="alignment">
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="pad"
                                                                            style="padding-left:16px;padding-right:32px;padding-top:3px;">
                                                                            <div style="font-family: sans-serif">
                                                                                <div class=""
                                                                                    ...
                                                                                    <p
																						...
																						@if($featured->product->amount < $featured->product->price)
																						<del>{!!$shop->country->currency->symbol!!}{{number_format($featured->product->price, 0)}}</del>
																						@endif
                                                                                        <span
                                                                                            style="font-size:20px;color:#2b3940;">

																							<strong>{!!$shop->country->currency->symbol!!}{{$featured->product->amount}}</strong>
																						</span>
                                                                                    </p>
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="pad"
                                                                            style="padding-bottom:3px;padding-left:16px;padding-right:32px;padding-top:3px;">
                                                                            <div style="font-family: sans-serif">
                                                                                <div class=""
                                                                                    style="font-size: 14px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 21px; color: #555555; line-height: 1.5;">
                                                                                    <p style="margin: 0; font-size: 14px; mso-line-height-alt: 21px;">
                                                                                        <span style="color:#2b3940;font-size:14px;">
																							<strong>
																								<span style="">
																									<span style="">{{$featured->product->name}} </span>
																								</span>
																							</strong>
																						</span>
                                                                                    </p>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="pad" style="padding-bottom:10px;padding-left:16px;padding-right:32px;padding-top:0px;">
                                                                            <div style="font-family: sans-serif">
                                                                                <div class="" style="font-size: 14px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 21px; color: #555555; line-height: 1.5;">
                                                                                    <p style="margin: 0; font-size: 14px; mso-line-height-alt: 21px;">
                                                                                        <span style="color:#7e8989;">{{$featured->product->description}}</span>
																					</p>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="pad"
                                                                            style="padding-bottom:20px;padding-left:16px;padding-right:32px;padding-top:7px;text-align:left;">
                                                                            <div align="left" class="alignment">
                                                                                <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" style="height:39px;width:133px;v-text-anchor:middle;" arcsize="8%" stroke="false" fillcolor="#f75c03"><w:anchorlock/><v:textbox inset="0px,0px,0px,1px"><center style="color:#ffffff; font-family:Tahoma, sans-serif; font-size:14px"><![endif]-->
                                                                                <a href="{{route('product.show',$featured->product)}}"
                                                                                    style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#f75c03;border-radius:3px;width:auto;border-top:0px solid transparent;font-weight:undefined;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:5px;padding-bottom:6px;font-family:Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif;font-size:14px;text-align:center;mso-border-alt:none;word-break:keep-all;">
                                                                                    <span style="padding-left:20px;padding-right:20px;font-size:14px;display:inline-block;letter-spacing:normal;">
																						<span style="margin:0;word-break:break-word;">
																							<span data-mce-style="" style="line-height: 28px;">
														...
														<tr>
															<td align="center">
																<table class="center" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
																	<tr>
																		<td class="text-btn-large" bgcolor="#00FA00" style="font-family:'Poppins', Arial,sans-serif; font-size:15px; line-height:18px; text-align:center; border:0px solid #cd6502; padding:15px 0px;">
																			<a href="{{route('vendor.show',$shop)}}" target="_blank" class="link-2" style="color:#fff; text-decoration:none;padding:15px 200px;">
																				<span class="link-2" style="color:#fff; text-decoration:none;">See All Products</span>
																			</a>
																		</td>
																	</tr>
																</table>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td class="p30-15 bbrr"
                                        style="padding: 20px 20px; border-radius:0px 0px 26px 26px;"
                                        bgcolor="#ffffff">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                            style="padding-top:40px; border-top:1px solid #ddd">
                                            <tr>
                                                        ...
                                                        <tr>
                                                            <td class="img" width="55"
                                                                ...
                                                                <a href="#" target="_blank">
                                                                    <img src="{{ asset('images/site/t2_instagram.jpg') }}"
                                            ...
                                            <tr>
                                                <td class="text-footer2"
                                                    style="color:#999999; font-family:Poppins,sans-serif; font-size:12px; line-height:26px; text-align:center;">
                                                    Copyright &copy; 2022 <span
                                                        style="font-weight:500;color:#00b207">Expiring Soon</span></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
