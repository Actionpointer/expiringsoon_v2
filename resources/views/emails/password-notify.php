										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td class="p30-15" style="padding: 20px 30px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="h1 pb25" style="color:#666; font-family:Poppins,sans-serif; font-size:13px; line-height:25px; text-align:center; padding-bottom:15px;"><span style="font-size:16px;font-weight:600">Password changed successfully!</span><br />Your password has been updated<br/ > Login with your new password</td>
														</tr>
														<tr>
															<td class="text-btn-large" align="center">
																<div style="background:#5fb882;width:50%;color:#fff; font-family:'Poppins', Arial,sans-serif; font-size:15px; line-height:18px; text-align:center; padding:15px 35px;border-bottom:1px solid #ddd"><a href="https://expiring.soon/login.php" target="_blank" class="link-2" style="color:#fff; text-decoration:none;"><span class="link-2" style="color:#fff; text-decoration:none;">Click here to Login</span></a></div>
															</td>
														</tr>
														<tr>
