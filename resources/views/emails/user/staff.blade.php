...
<head>
	...
	<!--<![endif]-->
	<title>Welcome | Expiring Soon</title>
	<!--[if gte mso 9]>
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td class="p30-15" style="padding: 20px 30px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="h1 pb25" style="color:#000000; font-family:'Playfair Display', Georgia,serif; font-size:25px; line-height:35px; text-align:center; padding-bottom:15px;"><span style="font-size:18px">Hi {{$newUser ? 'there':$user->firstname}},</span><br /><i>Welcome to {{$store->name}} Store</i></td>
														</tr>
														<tr>
															<td class="text-center pb25" style="color:#666666; font-family:Poppins,sans-serif; font-size:14px; line-height:30px; text-align:center; padding-bottom:25px;">
																<div style="margin:auto;width:80%">Here is an invitation to join us to manage {{$store->name}} store. We have provided you all you will need to manage the store effectively.
																	Kindly Login with this your email and password: {{$password}}
																</div>
																...
																<table class="center" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
																	<tr>
																		<td class="text-button" style="padding:12px">
																			<a href="{{route('signin')}}" target="_blank" style="font-size:18px;padding:15px;background:#02c780;color:white;border-radius:10%" class="link">Login</a>
																		</td>
																	</tr>
																</table>
															</td>
