				...
				<table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell">
					<tr>
						<td class="td container" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; margin:0; font-weight:normal; padding:55px 0px;">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td class="fluid-img"><img src="{{asset('src/images/site/img-welcome.jpg')}}" border="0" width="100%" alt="" /></td>
								</tr>
							</table>
							<!-- END Hero Image -->
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="h1 pb25" style="color:#666; font-family:Poppins,sans-serif; font-size:13px; line-height:25px; text-align:left; padding-bottom:15px;">
                                                                <span style="font-size:16px;font-weight:600">Dear John Okigwe,</span><br />
                                                                See how your ads in <b>123232</b> are performing<br /> 
														...
														<tr>
															<td style="color:#666666; font-family:Poppins,sans-serif; font-size:13px; line-height:30px; padding-bottom:25px;">
																<div class="cart-row">
                                                                    ...
                                                                    <div class="cart-item-qty" style="font-weight: 600;">Views</div>
                                                                    <div class="cart-item" style="font-weight: 600;">Clicks</div>
                                                                    <div class="cart-item" style="font-weight: 600;">Purchases</div>
																</div>
																...
																<table class="center" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
																	<tr>
																		<td class="text-btn-large" bgcolor="#cd6502" style="font-family:'Poppins', Arial,sans-serif; font-size:15px; line-height:18px; text-align:center; border:0px solid #cd6502; padding:15px 35px;">
                                                                            <a href="#" target="_blank" class="link-2" style="color:#fff; text-decoration:none;">
                                                                                <span class="link-2" style="color:#fff; text-decoration:none;">View Insights</span>
                                                                            </a>
                                                                        </td>
																	</tr>
																</table>
