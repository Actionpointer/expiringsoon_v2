...
<head>
	...
	<title>Shop @if($shop->approved) Approved @else Rejected @endif | Expiring Soon</title>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="h1 pb25" style="color:#666; font-family:Poppins,sans-serif; font-size:13px; line-height:25px; text-align:left; padding-bottom:15px;">
																...
																<br />Your shop has been @if($shop->approved) Approved @else Rejected @endif
																@if($shop->rejection_reason)
															    <br />Rejection Reason:  {{$shop->rejection_reason}}
                                                                @endif
														...
														<tr>
															<td class="text-btn-large" bgcolor="#00FA00" style="font-family:'Poppins', Arial,sans-serif; font-size:15px; line-height:18px; text-align:center; border:0px solid #cd6502; padding:15px 35px;">
																<a href="{{route('vendor.shop.show',$shop)}}" target="_blank" class="link-2" style="color:#fff; text-decoration:none;padding:15px 180px;">
																	<span class="link-2" style="color:#fff; text-decoration:none;">Manage Shop</span>
																</a>
															</td>
														</tr> 
