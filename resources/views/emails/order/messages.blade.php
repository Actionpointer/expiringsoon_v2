...
<head>
	...
	<title>Order Message | Expiring Soon</title>
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="h1 pb25" style="color:#666; font-family:Poppins,sans-serif; font-size:13px; line-height:25px; text-align:left; padding-bottom:15px;">
                                                                <span style="font-size:16px;font-weight:600">New Order Message:</span>
                                                                <br />Order Number : <b>{{$orderMessage->order->slug}}</b>
                                                                <br/> Sender: <b>
                                                                    @if($orderMessage->sender_type == 'App\Models\User')
                                                                        @if($orderMessage->sender_id == $orderMessage->order->user_id)
                                                                        {{$orderMessage->sender->name}}
                                                                        @else
																...
																<table class="center" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
																	<tr>
																		<td class="text-button" style="padding:12px">
																			<a href="https://ng.expiringsoon.shop/invoice.php?ref=123232" target="_blank" class="link"><img src="{{asset('backend/images/site/btn-orderdetails.png')}}" width="175"></a></td>
																	</tr>
																</table>
															</td>
														</tr>
														<tr>
															...
															<div style="margin:auto;width:80%"><strong style="font-size:14px">Thank you for using Expiring Soon!</strong><br />
															</td>
														</tr>
														<!-- END Button -->
													</table>
													...
													<table border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="img" width="55" style="font-size:0pt; line-height:0pt; text-align:center;">
																<a href="#" target="_blank"><img src="{{asset('backend/images/site/t2_instagram.jpg')}}" width="34" height="34" border="0" alt="" /></a></td>
														</tr>
													</table>
												</td>
											</tr>
