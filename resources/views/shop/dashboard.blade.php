                  ...
                  <div class="dashboard__user-profile-info">
                    ...
                    {{-- @if($user->role =='Shopper') 
                        <p class="font-body--md-400 designation">Wallet: 
                            <span style="color:#00b207;font-weight:500">N{{number_format($shop->wallet, 2)}}</span>
                        </p>
                        <a href="{{route('settings')}}#topUpSection" class="edit font-body--lg-500">Top-Up Wallet</a>
                    @else --}}
                        ...
                        <div style="float:left;padding-right:20px;margin-right:20px;border-right:2px solid #e0dfdf">
                            <p align="left" class="font-body--md-400 designation">Total Sales</p>
                                <div style="margin-top:-10px">
                                    <a href="{{route('shop.order.list',$shop)}}" class="edit font-body--lg-500" style="font-size:20px">N -0-</a>
                                </div>
                        </div>
                        <div style="float:left;margin-right:10px">
                            <p align="left" class="font-body--md-400 designation">Balance</p>
                            <div style="margin-top:-10px">
                                <a href="#" class="edit font-body--lg-500" style="font-size:20px">N{{number_format($shop->wallet, 2)}}</a>
                            </div>
                        </div>
                    </div>
                    <div>
              ...
              <div class="col-lg-5">
                <div class="dashboard__user-billing dashboard-card">
                  ...
                  <div class="dashboard__user-billing-info">
                    ...
                    <p class="dashboard__user-billing-number font-body--lg-400" > {{$shop->phone}} </p>
                  </div>
                            ...
                            @forelse($shop->carts->where('status','Delivered')->sortByDesc('date')->take(10) as $cart)
                                    ...
                                    <tr>
                                        ...
                                        <td class="dashboard__order-history-table-item order-total "> 
                                            <p class="order-total-price">   N{{number_format($shop->commission / 100 * $cart->total, 0)}} </p>
                                        </td>
                                        <!-- Site Split  -->
                                        <td class="dashboard__order-history-table-item order-total"> 
                                            <p class="order-total-price">   N{{number_format($cart->total - ($shop->commission / 100 * $cart->total), 0)}} </p>
                                        </td>
                                        <!-- Status -->
