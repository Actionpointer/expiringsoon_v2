            ...
            <div class="container">
              ...
              <div class="dashboard__content-card">
                ...
                <div class="dashboard__content-card-body">
                  <form method="post" id="editinfo" action="{{route('shop.store')}}" enctype="multipart/form-data">@csrf
                    <div class="row">
                        ...
                        <div class="contact-form__content">
                            ...
                            <div class="contact-form__content-group row">
                              ...
                              <div class="contact-form-input col-lg-6">
                                ...
                                <select  name="city_id" class="form-control-lg w-100 contact-form-input__dropdown text-muted">
