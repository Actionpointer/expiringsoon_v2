...
<div class="row shop__product-items">
  ...
  // Fetch Products
  if($catid == 'All'){
  $query = "SELECT * FROM products WHERE userid='".$_POST['userid']."' ORDER BY uploaded DESC LIMIT 200";
  } else {
  $query = "SELECT * FROM products WHERE cat_id='$catid' AND userid='".$_POST['userid']."' ORDER BY uploaded DESC LIMIT 200";
  }
