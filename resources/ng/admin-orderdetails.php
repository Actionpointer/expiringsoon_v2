            ...
            <div class="container">
              ...
              <div class="dashboard__order-history">
                <div class="dashboard__order-history-title">
                  ...
                  <a href="admin-dashboard.php">back to list</a>
                </div>
                      ...
                      <div class="dashboard__totalpayment-card">
                        <div class="dashboard__totalpayment-card-header">
                          <div class="dashboard__totalpayment-card-header-item">
                            ...
                            <p class="details order-id">#<?php echo $oqr['orderid']; ?></p>
                          </div>
                          <div class="dashboard__totalpayment-card-header-item">
                            <h5 class="title">Payment Method:</h5>
                            <p class="details order-id"><?php echo $oqr['paymentmethod']; ?></p>
                          </div>
                        </div>
                        ...
                        <div class="dashboard__totalpayment-card-body">
                          <div class="dashboard__totalpayment-card-body-item">
                            ...
                            <p class="font-body--md-500">N<?php echo number_format($inv_orderttl, 0); ?></p>
                          </div>
                          <div class="dashboard__totalpayment-card-body-item">
                            <h5 class="font-body--md-400">VAT 7%:</h5>
                            <p class="font-body--md-500">N<?php echo number_format($inv_vat, 0); ?></p>
                          </div>
                          <div class="dashboard__totalpayment-card-body-item">
                            <h5 class="font-body--md-400">Shipping:</h5>
                            <p class="font-body--md-500">N500</p>
                          </div>
                          <div
                            class="dashboard__totalpayment-card-body-item total"
                          >
                            <h5 class="font-body--xl-400">Total:</h5>
                            <p class="font-body--xl-500">N<?php echo number_format($inv_vat + $inv_orderttl + 500, 0); ?></p>
                          </div>
                        </div>
                      </div>
                    </div>
