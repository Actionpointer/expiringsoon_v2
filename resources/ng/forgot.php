				...
				<table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell">
					<tr>
						<td class="td container" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; margin:0; font-weight:normal; padding:55px 0px;">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td class="fluid-img"><img src="https://ng.expiringsoon.shop/img/img-verify-2.jpg" border="0" width="100%" alt="" /></td>
								</tr>
							</table>
							<!-- END Hero Image -->
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td class="p30-15" style="padding: 20px 30px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															<td class="h1 pb25" style="color:#666; font-family:Poppins,sans-serif; font-size:13px; line-height:25px; text-align:center; padding-bottom:15px;"><span style="font-size:16px;font-weight:600">Dear <?php echo $uqr['fname']; ?>,</span><br />You have requested to reset your password.<br />Click the button below to set a new password.</td>
														</tr>
														<tr>
															<td class="text-btn-large" align="center">
																<div style="background:#5fb882;width:50%;color:#fff; font-family:'Poppins', Arial,sans-serif; font-size:15px; line-height:18px; text-align:center; padding:15px 35px;"><a href="https://expiring.soon/reset.php?uid=<?php echo $_GET['uid']; ?>" target="_blank" class="link-2" style="color:#fff; text-decoration:none;"><span class="link-2" style="color:#fff; text-decoration:none;">Set a new Password</span></a></div>
															</td>
														</tr>
														<tr>
															...
															<div style="margin:auto;width:80%">If you didn't request a password reset, you can ignore this email.</div>
															</td>
														</tr>
														<!-- END Button -->
													</table>
