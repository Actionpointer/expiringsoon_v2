...
/*$hash = password_hash('Grabbr-2022', PASSWORD_BCRYPT);
$con->autocommit(FALSE);
$con->query("UPDATE admin SET admin='admin', password='$hash' WHERE id='1'");
$con->commit();*/
...
$user = "SELECT * FROM admin WHERE admin='$admin'";
...
header("Location: admin-checklogin.php");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <body>
    ...
    echo '<div class="error"><p style="color:#fff">We couldn\'t find that username</p></div>';
    }
    ...
    <section class="sign-in section section--xl">
      <div class="container">
        <div class="form-wrapper">
          <h6 class="font-title--sm">Admin Login</h6>
          <form method="post">
