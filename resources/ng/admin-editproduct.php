...
$con->commit();
header("Location: admin-editproduct.php?pid=".$_POST['pid']."&saved");
exit();
}
if(isset($_FILES['imageUpload']) && !empty($_FILES['imageUpload']['name'])) {
$path = "uploads/";
...
header("Location: admin-editproduct.php?pid=".$_POST['pid']."&fail");
exit();
}
            ...
            <div class="container">
              ...
              <div class="dashboard__content-card">
                <div class="dashboard__order-history-title" style="border-bottom:1px solid #ddd">
                  ...
                  <a href="admin-products.php" class="font-body--lg-500">
                    Back to List</a
                  >
                </div>
