...
<head>
    ...
    <title>Order History | Expiring Soon</title>
    <link
      rel="icon"
      type="image/png"
      ...
      <div class="breedcrumb__img-wrapper">
        ...
        <div class="container">
          <ul class="breedcrumb__content">
            ...
            <li class="active"><a href="orders.php">Order History</a></li>
          </ul>
        </div>
      </div>
    </div>
                  ...
                  <div class="table-responsive">
                    <table id="datatable" class="table display" style="width:100%;font-size:13px">
                      ...
                      <tbody>
                        <?php
                        // Fetch Orders
                        $query = "SELECT * FROM orders WHERE userid='".$uqr['id']."' ORDER BY date DESC";
