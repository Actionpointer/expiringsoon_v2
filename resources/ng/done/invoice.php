...
$backlink = '<a href="account.php">Back to Orders</a>';
}
else{
$backlink = '<a href="cart.php">Back to Cart</a>';
}
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://pick-it-ng.herokuapp.com/api/orders/track/'.$oqr['trackingcode'].'',
  ...
  CURLOPT_HTTPHEADER => array(
    'Authorization: 5ff878765849597f0f45'
  ),
));
...
<head>
    ...
    <title>Order Details #<?php echo $oqr['orderid']; ?> | Expiring Soon</title>
    <link
      rel="icon"
      type="image/png"
    ...
    $("form#rateService").on("submit", function(event){
    event.preventDefault();
    $("#process").html("Submitting...");
  ...
  <body>
      ...
      <div class="breedcrumb__img-wrapper">
        ...
        <div class="container">
          <ul class="breedcrumb__content">
            ...
            <li class="active"><a href="orders.php">Order #<?php echo $oqr['orderid']; ?></a></li>
          </ul>
        </div>
      </div>
    </div>
    <!-- breedcrumb section end   -->
        ...
        echo'
        <div class="notify">
        <p style="color:#fff">Your Order was completed and is now processing</p>
        </div>
        ';
        }
        ?>
            ...
            <nav class="dashboard__nav">
              ...
              <ul class="dashboard__nav-item">
                <li class="dashboard__nav-item-link active">
                  <a href="account.php" class="font-body--lg-400">
                    <span class="icon">
                ...
                <?php if($uqr['usertype']=='Shopper') { ?>
                <!-- Order History -->
                <li class="dashboard__nav-item-link">
                  <a href="orders.php" class="font-body--lg-400">
                    <span class="icon">
              ...
              <?php } ?>
                <!-- Wishlist -->
                <li class="dashboard__nav-item-link">
                  <a href="wishlist.php" class="font-body--lg-400">
                    <span class="icon">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                      >
                        <path   d="M11.9997 21.0538C-7.99987 9.99967 6.00011 -2.00033 11.9997 5.58772C18.0001 -2.00034 32.0001 9.99967 11.9997 21.0538Z"   stroke="currentColor"   stroke-width="1.5" />
                      </svg>
                    </span>
                    <span class="name"> Wishlist</span>
                  </a>
                </li>
                <?php if($uqr['usertype']=='Vendor'){ ?>
                <!-- My Products  -->
                <li class="dashboard__nav-item-link">
                  <a href="products.php" class="font-body--lg-400">
                    <span class="icon">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                      > <path   d="M8 10H5L3 21H21L19 10H16M8 10V7C8 4.79086 9.79086 3 12 3V3C14.2091 3 16 4.79086 16 7V10M8 10H16M8 10V13M16 10V13"   stroke="currentColor"   stroke-width="1.5"   stroke-linecap="round"   stroke-linejoin="round" />
                      </svg>
                    </span>
            ...
            <div class="container">
              ...
              <div class="dashboard__order-history">
                <div class="dashboard__order-history-title">
                  <h2 class="font-body--xxl-500">Order #<?php echo $oqr['orderid']; ?></h2>
                  <?php if($uqr['usertype']=='Shopper') { ?><a href="orders.php">Back to List</a><?php } else{ ?><?php echo $backlink; ?><?php } ?>
                </div>
                        ...
                        <div class="dashboard__details-card-item">
                          ...
                          <div class="dashboard__details-card-item__inner">
                            <h2 class="font-body--lg-400 name">
                              <?php echo $uqr['fname']; ?> <?php echo $uqr['lname']; ?>
                            </h2>
                            <p class="font-body--md-400">
                              <?php echo $uqr['address']; ?>, <?php echo $uqr['state']; ?>
                            </p>
                          </div>
                          <div class="dashboard__details-card-item__inner">
                            ...
                            <div class=" dashboard__details-card-item__inner-contact " >
                              ...
                              <p class="font-body--md-400"><?php echo $uqr['phone']; ?></p>
                            </div>
                          </div>
                        </div>
                        <div class="dashboard__details-card-item">
                          ...
                          <div class="dashboard__details-card-item__inner">
                            <h2 class="font-body--lg-400 name">
                              <?php echo $oqr['recipient']; ?>
                            </h2>
                            <p class="font-body--md-400">
                              <?php echo $oqr['deliveryaddress']; ?>
                            </p>
                          </div>
                          <div class="dashboard__details-card-item__inner">
                            <div class=" dashboard__details-card-item__inner-contact">
                            ...
                            <div class=" dashboard__details-card-item__inner-contact">
                              <h5 class="title">Phone</h5>
                              <p class="font-body--md-400"><?php echo $oqr['deliverycontact']; ?></p>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="dashboard__totalpayment-card">
                        <div class="dashboard__totalpayment-card-header">
                          <div class="dashboard__totalpayment-card-header-item">
                            ...
                            <p class="details order-id"><?php echo $oqr['trackingcode']; ?></p>
                          </div>
                        </div>
                        ...
                        <div class="dashboard__totalpayment-card-body">
                          <div class="dashboard__totalpayment-card-body-item">
                            ...
                            <p class="font-body--md-500"><?php echo $oqr['paymentmethod']; ?></p>
                          </div>
                          <div class="dashboard__totalpayment-card-body-item">
                            <h5 class="font-body--md-400">Subtotal:</h5>
                            <p class="font-body--md-500">N<?php echo number_format($inv_orderttl, 2); ?></p>
                          </div>
                          <div class="dashboard__totalpayment-card-body-item">
                            <h5 class="font-body--md-400">VAT <?php echo $stqr['vat']; ?>%:</h5>
                            <p class="font-body--md-500">N<?php echo number_format($inv_vat, 2); ?></p>
                          </div>
                          <div class="dashboard__totalpayment-card-body-item">
                            <h5 class="font-body--md-400">Shipping:</h5>
                            <p class="font-body--md-500">N<?php echo number_format($oqr['deliveryfee'], 2); ?></p>
                          </div>
                          <div class="dashboard__totalpayment-card-body-item total" >
                            <h5 class="font-body--xl-400">Total:</h5>
                            <p class="font-body--xl-500">N<?php echo number_format($finalttl, 2); ?></p>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <?php if($oqr['deliverystatus']=='Processing'){ ?>
                ...
                <?php } if($oqr['deliverystatus']=='Shipped'){ ?>
                <div class="progress__bar progress__bar-1x">
                  <div class="progress__bar-item active">
                    <div class="progress__bar-item-ball">
                      <p class="font-body--md-400   count-number count-number-active " > 01 </p>
                      <span class="check-mark"> <svg   width="20"   height="20"   viewBox="0 0 20 20"   fill="none"   xmlns="http://www.w3.org/2000/svg" >
                          <path     d="M16.6663 5.83301L7.49967 14.9997L3.33301 10.833"     stroke="currentColor"     stroke-width="2"     stroke-linecap="round"     stroke-linejoin="round"   />
                        </svg>
                      </span>
                    </div>
                  ...
                  <div class="progress__bar-item active">
                    <div class="progress__bar-item-ball">
                      <p class="   font-body--md-400   count-number count-number-active " > 03
                      </p>
                      <span class="check-mark">
                        <svg   width="20"   height="20"   viewBox="0 0 20 20"   fill="none"   xmlns="http://www.w3.org/2000/svg" >
                          <path     d="M16.6663 5.83301L7.49967 14.9997L3.33301 10.833"     stroke="currentColor"     stroke-width="2"     stroke-linecap="round"     stroke-linejoin="round"   />
                  ...
                  <div class="progress__bar-item">
                    <div class="progress__bar-item-ball">
                      <p class="   font-body--md-400   count-number count-number-active " > 04
                      </p>
                      <span class="check-mark">
                        <svg   width="20"   height="20"   viewBox="0 0 20 20"   fill="none"   xmlns="http://www.w3.org/2000/svg" >
                          <path     d="M16.6663 5.83301L7.49967 14.9997L3.33301 10.833"     stroke="currentColor"     stroke-width="2"     stroke-linecap="round"     stroke-linejoin="round"   />
              ...
              <?php } if($oqr['deliverystatus']=='Delivered'){ ?>
                  <div class="progress__bar progress__bar-1x">
                    <div class="progress__bar-item active">
                      <div class="progress__bar-item-ball">
                        <p class="font-body--md-400 count-number count-number-active" > 01 </p>
              ...
              <?php if($oqr['deliverystatus']=='Delivered' && $oqr['rating']!=='None'){ ?>
                <div class="row billing__content">
                  <div class="col-lg-8">
                      <div class="billing__content-card-header">
                        <h2 class="font-body--xxxl-500" style="font-size:17px">Thank you for your feedback</h2>
                        <p style="margin-top:-15px;font-size:13px;color:#888">Your Rating</p>
                        <p><?php
                        if($oqr['rating']=='Very Poor'){ ?>
                ...
                <div class="col-lg-8">
                  <div class="billing__content-card">
                    <div class="billing__content-card-header">
                      <h2 class="font-body--xxxl-500" style="font-size:17px">Rate Your Experience</h2>
                    </div>
                    <div class="billing__content-card-body">
                      <form method="post" id="rateService">
                        <input type="hidden" name="ratingid" value="<?php echo $_GET['ref']; ?>">
                        <div class="contact-form__content">
                          <div class="bill-card__payment-method-item">
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="rating" id="vpoor" value="Very Poor"/>
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="rating" id="fair" value="Fair" />
                              <label class="form-check-label font-body--400" >
                                <span class="fa fa-star star"></span>
                                <span class="fa fa-star star"></span>
                                <span class="fa fa-star star"></span>
                            ...
                            <div class="form-check">
                              <input class="form-check-input" type="radio" name="rating" id="good" value="Good" checked />
                              <label class="form-check-label font-body--400" >
                                <span class="fa fa-star star"></span>
                                <span class="fa fa-star star"></span>
                                <span class="fa fa-star star"></span>
                          ...
                          <div class="contact-form-input contact-form-textarea" style="margin-top:20px">
                            <textarea name="ratingnote" id="note" placeholder="Leave a Comment (Optional)"></textarea>
                          </div>
                          <div class="form-button">
                            <button type="submit" id="btn-submit" class="button button--md w-100">Submit</button>
                            <div id="process" style="font-size:14px;margin-top:10px;font-weight:500"></div>
                          </div>
                        </div>
                      </form>
                    </div>
