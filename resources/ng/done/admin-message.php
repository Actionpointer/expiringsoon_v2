...
$msq = mysqli_query($con, "SELECT * FROM messages WHERE msgid='".$_GET['ref']."'");
$msgr = mysqli_fetch_assoc($msq);

$oqq = mysqli_query($con, "SELECT * FROM orders WHERE orderid='".$msgr['orderid']."'");
$oqr = mysqli_fetch_assoc($oqq);

$uqq = mysqli_query($con, "SELECT * FROM users WHERE id='".$msgr['userid']."'");
$uqr = mysqli_fetch_assoc($uqq);

$stq = mysqli_query($con, "SELECT * FROM settings");
$stqr = mysqli_fetch_assoc($stq);

$sum = "SELECT sum(total) as inv_ttl FROM cart WHERE userid='".$msgr['id']."' AND orderid='".$oqr['orderid']."'";
...
<head>
	...
	<!--<![endif]-->
	<title>Order Receipt No. <?php echo $oqr['orderid']; ?> | Grabbr</title>
	<!--[if gte mso 9]>
				...
				<table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell">
					<tr>
						<td class="td container" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; margin:0; font-weight:normal; padding:55px 0px;">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									<td class="fluid-img" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://expiringsoon.shop/img/img-verify.jpg" border="0" width="100%" alt="" /></td>
								</tr>
							</table>
							<!-- END Hero Image -->
												...
												<td class="p30-15" style="padding: 20px 30px;">
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														...
														<tr>
															...
															<div style="margin:auto;width:80%"><strong style="font-size:16px">Message from Admin</strong><br />
															<Span style="font-weight:bold"><?php echo $msgr['subject']; ?></span><br /><?php echo $msgr['message']; ?></div>
															</td>
														</tr>
														<tr>
															<td class="text-center pb25" style="color:#666666; font-family:Poppins,sans-serif; font-size:14px; line-height:30px; text-align:center; padding-bottom:25px;">
															<div style="margin:auto;width:80%"><strong style="font-size:16px">Order Summary</strong><br />
														...
														<tr>
															<td style="color:#666666; font-family:Poppins,sans-serif; font-size:13px; line-height:30px; padding-bottom:25px;">
																...
																<?php
																$query = "SELECT * FROM cart WHERE userid='".$uqr['id']."' AND orderid='".$oqr['orderid']."' ORDER BY date DESC";
														...
														<tr>
															<td align="center">
																<table class="center" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
																	<tr>
																		<td class="text-button" style="padding:12px"><a href="https://expiringsoon.shop/invoice.php?ref=<?php echo $oqr['orderid']; ?>" target="_blank" class="link"><img src="https://expiringsoon.shop/img/btn-orderdetails.png" width="200"></a></td>
																	</tr>
																</table>
															</td>
														</tr>
