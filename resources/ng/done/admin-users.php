...
$sum = "SELECT count(id) as ttl FROM users";
...
<head>
    ...
    <title>Manage Users | Expiring Soon</title>
    <link
      rel="icon"
      type="image/png"
        ...
        <div class="row dashboard__content">
          ...
          <div class="col-lg-9 section--xl pt-0" style="padding:10px;font-size:13px">
            <div class="dashboard__order-history-title" style="margin:auto;width:95%;border-bottom:1px solid #ddd;margin-bottom:10px">
              <p class="font-body--xl-500">Manage Accounts</p>
              <a href="#" class="font-body--lg-500"><?php echo number_format($ttlusers, 0); ?> Users</a>
            </div>
            <div class="container">
              <!-- Products -->
              <div class="table-responsive">
                <table id="datatable" class="table display" style="width:100%;font-size:13px">
                  ...
                  <tbody>
                    <?php
                    // Fetch Users
                    $query = "SELECT * FROM users ORDER BY registered DESC LIMIT 50";
                    $userdata = mysqli_query($con,$query);
                    if (mysqli_num_rows($userdata) == 0) {
                    echo '<div style="margin:auto;padding:1%;text-align:center"><img style="padding:10px;width:100px" src="img/exclamation.png"><br />There are no registered users at this time.</span></div>';
                    }
                      ...
                      <td class="cart-table-item align-middle" style="background-color:#fff">
                          <div class="cart-table__product-item-img">
                            <img
                              ...
                              alt="<?php echo $row['fname']; ?> <?php echo $row['lname']; ?>"
                              onerror="this.src='img/avatar.png';"
                            />
                          </div>
                      </td>
                      <td class="cart-table-item order-date align-middle">
                        <span class="font-body--lg-500" style="color:#000"><?php echo $row['id']; ?>. <?php echo $row['fname']; ?> <?php echo $row['lname']; ?></span>
                        <br />
                        <span style="font-size:12px;color:#888"><?php echo $row['email']; ?></span>
                      </td>
                      <!-- Price  -->
                      <td class="cart-table-item order-date align-middle">
                        <p class="font-body--lg-500" style="color:#00b207">N<?php echo number_format($row['wallet'], 2); ?></p>
                      </td>
                      <!-- Stock Status  -->
                      <td class="cart-table-item order-date align-middle">
                        <p class="font-body--lg-500"><?php echo $row['usertype']; ?> <?php if($row['usertype']=='Vendor' && $row['status']=='Approved') { ?><span class="iconify" style="color:#00b207" data-icon="akar-icons:check-box-fill" data-width="20" data-height="20"><?php } ?></p>
                      </td>
                      <td class="cart-table-item add-cart align-middle">
                        <div class="add-cart__wrapper">
                          <a
                            href="admin-edituser.php?uid=<?php echo $row['id']; ?>"
