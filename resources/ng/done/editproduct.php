...
<head>
    ...
    $(document).ready(function(){
      $("#editproductinfo").on("keyup change", function(e) {
      $("#process").html("Saving...");
...
// Fetch Product categories
      function getSubs(){
        ...
        // alert(val);
        $.post("getSubs.php",{catid:val}, function(data){
        $("#loadsubs").html(data);
    });
  }
...
var loadFile = function(event) {
  ...
  $.ajax({
         ...
         success : function(data) {
             console.log(data);
             // $('#process').html(data);
             btn.innerHTML = 'Product Photo Saved!';
         }
  });
  });
  });
      ...
      onSelect: function(date, instance) {
        //var date = "+date";
            ...
            ({
                ...
                url: "process.php",
                // data: "date="+date,
                data: {exp:date, pid: <?php echo $_GET['pid']; ?>},
                success: function(data) {
      ...
      <div class="breedcrumb__img-wrapper">
        ...
        <div class="container">
          <ul class="breedcrumb__content">
            ...
            <li class="active"><a href="account.php">My Products</a></li>
          </ul>
        </div>
      </div>
    </div>
            ...
            <div class="container">
              ...
              <div class="dashboard__content-card">
                <div class="dashboard__order-history-title" style="border-bottom:1px solid #ddd">
                  ...
                  <a href="products.php" class="font-body--lg-500">
                    Back to List</a
                  >
                </div>
                  ...
                  <div class="row">
                    <div class="col-lg-7 order-lg-0 order-2">
                      <form method="post" id="editproductinfo">
                        <input type="hidden" name="prod_id" value="<?php echo $_GET['pid']; ?>">
                        <div class="contact-form__content">
                          ...
                          <div class="bill-card__payment-method-item">
                            <div class="form-check">
                              <?php
                              $check = "SELECT * FROM featured WHERE userid='".$uqr['id']."' AND productid='".$prqr['id']."'";
                              $result = mysqli_query($con, $check);
                              $row = mysqli_fetch_assoc($result);
                              if (mysqli_num_rows($result) == 1){

                                // $expires = date("l, M jS Y", strtotime($row['date']));
                                $timeDiff = abs(strtotime($row['expires']) - strtotime($now2));
                              ...
                              <label
                                ...
                                for="feature"
                              >
                                The product is currently featured<br />
                                <div style="font-weight:500;margin-top:-8px;font-size:12px;color:#000">Expires in <?php echo $numberDays; ?> days</div>
                              </label>
                            <?php } else { ?>
                              <input
                                class="form-check-input"
                              ...
                              <label
                                ...
                                for="feature"
                              >
                                Feature this Product<br />
                                <div style="font-weight:500;margin-top:-8px;font-size:12px;color:#000">Show in "Featured" section on home page for 30 days at N<?php echo number_format($stqr['feature'], 0); ?></div>
                              </label>
                            <?php } ?>
                            </div>
                          </div>
                      ...
                      <div id="process" style="margin-top:10px;font-size:13px"></div>
                    </div>
                    <div class="col-lg-5 order-lg-0 order-1">
                      <div class="dashboard__content-card-img">
                        <form method="post" enctype="multipart/form-data" style="text-align: center" id="editPhoto">
                          <input type="hidden" name="prod_id3" value="<?php echo $_GET['pid']; ?>">
                          <div class="dashboard__content-img-wrapper" id="avatar">
                            <img
                              src="<?php echo $prqr['photo']; ?>"
                              alt="<?php echo $prqr['product']; ?>"
              ...
              <div class="dashboard__content-card">
                ...
                <div class="dashboard__content-card-body">
                  <form method="post" id="editcategory">
                    <input type="hidden" name="prod_id2" value="<?php echo $_GET['pid']; ?>">
                    <div class="contact-form__content">
                      ...
                      <div class="contact-form__content-group">
                        ...
                        <div class="contact-form-input">
                          ...
                          <select
                            ...
                            onChange="getSubs()"
                          >
                          <option value="<?php echo $cqr['id']; ?>" selected><?php echo $cqr['category']; ?></option>
                          <?php
                                  // Fetch Categories
                        ...
                        <div class="contact-form-input">
                          ...
                          >
                          <option value="<?php echo $sqr['id']; ?>" selected><?php echo $sqr['subcategory']; ?></option>
                          </select>
                        </div>
                      </div>
