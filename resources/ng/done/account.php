...
$sum = "SELECT sum(total) as ttsales FROM cart WHERE vendor='".$uqr['id']."' AND status='Delivered'";
$res = mysqli_query($con, $sum);
while ($row = mysqli_fetch_array($res)){
$ttlsales = $row['ttsales'];
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title><?php echo $uqr['fname']; ?> <?php echo $uqr['lname']; ?> | User Dashboard | Expiring Soon</title>
    <link
      rel="icon"
      type="image/png"
      ...
      <div class="breedcrumb__img-wrapper">
        ...
        <div class="container">
          <ul class="breedcrumb__content">
            ...
            <li class="active"><a href="account.php">Dashboard</a></li>
          </ul>
        </div>
      </div>
    </div>
        ...
        <div class="row dashboard__content">
          <div class="col-lg-3">
            <nav class="dashboard__nav">
              ...
              <!-- Sales History -->
              <li class="dashboard__nav-item-link">
                <a href="sales.php" class="font-body--lg-400">
                  <span class="icon">
                    <svg
                      width="16"
                      height="16"
                ...
                <div class="col-lg-7">
                  <div class="dashboard__user-profile dashboard-card">
                    <div class="dashboard__user-profile-img">
                      <img src="<?php echo $uqr['pic']; ?>" alt="<?php echo $uqr['fname']; ?> <?php echo $uqr['lname']; ?>" />
                    </div>
                    <div class="dashboard__user-profile-info">
                      <h5 class="font-body--xl-500 name"><?php echo $uqr['fname']; ?> <?php echo $uqr['lname']; ?></h5>
                      <?php if($uqr['usertype']=='Shopper') { ?>
                      <p class="font-body--md-400 designation">Wallet: <span style="color:#00b207;font-weight:500">N<?php echo number_format($uqr['wallet'], 2); ?></span></p>
                      <a href="settings.php#topUpSection" class="edit font-body--lg-500">Top-Up Wallet</a>
                    <?php } else{ ?>
                    ...
                    <div style="margin-top:-10px"><a href="sales.php" class="edit font-body--lg-500" style="font-size:20px">N 0</a></div>
                  </div>
                  <div style="float:left;margin-right:10px">
                    <p align="left" class="font-body--md-400 designation">Balance</p>
                    <div style="margin-top:-10px"><a href="#" class="edit font-body--lg-500" style="font-size:20px">N<?php echo number_format($uqr['wallet'], 2); ?></a></div>
                  </div>
                </div>
                    <div><a href="settings.php#requestPayout" class="edit font-body--lg-500">Request Payout</a></div>
                  <?php } ?>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-lg-5">
                  <div class="dashboard__user-billing dashboard-card">
                    <h2 class="dashboard__user-billing-title font-body--md-500">
                      <?php if($uqr['usertype']=='Shopper') { ?>Billing Address<?php } else{ ?>Pick-Up Address<?php } ?>
                    </h2>
                    <div class="dashboard__user-billing-info">
                      <h5
                        class="dashboard__user-billing-name font-body--xl-500"
                      >
                        <?php echo $uqr['usertype']; ?> #<?php echo $uqr['userid']; ?>
                        <?php if($uqr['usertype']=='Vendor' && $uqr['status']=='Approved') { ?><span class="iconify" style="color:#00b207" data-icon="akar-icons:check-box-fill" data-width="20" data-height="20"><?php } ?>
                      ...
                      <p
                        class="dashboard__user-billing-email font-body--lg-400"
                      >
                        <?php echo $uqr['email']; ?>
                      </p>
                      <p
                        class="dashboard__user-billing-number font-body--lg-400"
                      >
                        <?php echo $uqr['phone']; ?>
                      </p>
                    </div>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php
                        // Fetch Orders
                        $query = "SELECT * FROM cart WHERE vendor='".$uqr['id']."' AND status='Delivered' ORDER BY date DESC LIMIT 10";
                        $proddata = mysqli_query($con,$query);
                        if (mysqli_num_rows($proddata) == 0) {
                        echo '<div style="margin:auto;padding:1%;text-align:center;margin-bottom:5%"><img style="padding:10px;width:100px" src="img/exclamation.png"><br />You have no orders at this time.</div>';
                        }
                        ...
                        // $orderdate = date("D, M jS, Y", strtotime($row['date']));
                        $orderdate = $row['date'];
                        $createDate = new DateTime($orderdate);
                        $strip = $createDate->format('Y-m-d');

                        $vendorsplit = ($uqr['commission'] / 100) * $row['total'];
                        $sitesplit = $row['total'] - $vendorsplit;
                        $deliveryfee = '500';
                        $finalttl = $vat + $row['total'] + $deliveryfee;
                        ?>
                        <tr>
                          <!-- Order Id  -->
                          <td
                          ...
                          >
                            <span style="font-weight:500"><?php echo $pqr['product']; ?></span><br/>
                          </td>
                          <!-- Date  -->
                          <td
                            class="
                          ...
                          >
                            <p class="order-total-price">
                              N<?php echo number_format($vendorsplit, 0); ?>
                            </p>
                          </td>
                          <!-- Site Split  -->
                          <td
                          ...
                          >
                            <p class="order-total-price">
                              N<?php echo number_format($sitesplit, 0); ?>
                            </p>
                          </td>
                          <!-- Status -->
                          <td
                          ...
                          <td
                            ...
                            "
                          >
                            <a href="invoice.php?ref=<?php echo $row['orderid']; ?>"><span class="iconify" data-icon="ant-design:info-circle-filled" data-width="24" data-height="24"></span></a>
                          </td>
                        </tr>
                      <?php } ?>
                      </tbody>
            ...
            <?php } ?>
              ...
              <!-- Order History -->
                ...
                <div class="dashboard__order-history-title">
                  ...
                  <a href="orders.php" class="font-body--lg-500">
                    View All</a>
                </div>
                <div class="dashboard__order-history-table">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php
                        // Fetch Orders
                        $query = "SELECT * FROM orders WHERE userid='".$uqr['id']."' ORDER BY date DESC LIMIT 10";
                        $proddata = mysqli_query($con,$query);
                        if (mysqli_num_rows($proddata) == 0) {
                        echo '<div style="margin:auto;padding:1%;text-align:center;margin-bottom:5%"><img style="padding:10px;width:100px" src="img/exclamation.png"><br />You have no orders at this time.</div>';
                        }
                        ...
                        <tr>
                          ...
                          <td
                            class="dashboard__order-history-table-item order-id"
                          >
                            <span style="font-weight:500">#<?php echo $row['orderid']; ?></span>
                          </td>
                          <!-- Date  -->
                          <td
                            class="
                          ...
                          >
                            <p class="order-total-price">
                              N<?php echo number_format($row['total'], 0); ?>
                            </p>
                          </td>
                          <!-- Status -->
                          <td
                          ...
                          <td
                            ...
                            "
                          >
                          <?php if($row['deliverystatus']=='Incomplete'){ ?>
                            <a href="cart.php"> Complete Order</a>
                          <?php } else{ ?>
                            <a href="invoice.php?ref=<?php echo $row['orderid']; ?>"><span class="iconify" data-icon="ant-design:info-circle-filled" data-width="24" data-height="24"></span></a>
                          <?php } ?>
                          </td>
