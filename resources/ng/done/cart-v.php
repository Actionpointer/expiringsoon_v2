            ...
            <div class="cart-table">
              <div class="table-responsive">
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    if(isset($_SESSION['orderid']) && !empty($_SESSION['orderid'])) {
                    if(isset($_COOKIE['email'])){
                    $qq = mysqli_query($con, "SELECT * FROM cart WHERE vendor='$vendor' AND userid='".$uqr['id']."' AND orderid='".$_SESSION['orderid']."' ORDER BY date DESC");
                    } else {
                    $qq = mysqli_query($con, "SELECT * FROM cart WHERE vendor='$vendor' AND orderid='".$_SESSION['orderid']."' ORDER BY date DESC");
                    }
              ...
              <form action="#">
                <div class="cart-table-action-btn d-flex">
                  <a href="checkout-v.php?v=<?php echo $vqr['id']; ?>" class="button button--md update" style="background:#00b207;color:#fff"
                    >Buy from this Seller</a>
                </div>
              </form>
            </div>
          <?php }} ?>
