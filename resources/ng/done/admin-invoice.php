...
$sum = "SELECT sum(total) as inv_ttl FROM cart WHERE orderid='".$_GET['ref']."'";
...
<head>
    ...
    $("form#orderstatus").on("submit", function(event){
    event.preventDefault();
    var btn = document.getElementById("btn-update");
    btn.innerHTML = 'Saving...';
    $.post('process.php', $(this).serialize(), function(data) {
      btn.disabled = true;
      btn.innerHTML = 'Order Status Updated';
      btn.style.backgroundColor = "#666666"
    });
  });

  $("form#adminMessage").on("submit", function(event){
  event.preventDefault();
      ...
      <div class="breedcrumb__img-wrapper">
        ...
        <div class="container">
          <ul class="breedcrumb__content">
            ...
            <li class="active"><a href="#">Order #<?php echo $oqr['orderid']; ?></a></li>
          </ul>
        </div>
      </div>
    </div>
        ...
        <div class="row dashboard__content">
          ...
          <div class="col-lg-9 section--xl pt-0">
            <div class="container">
              ...
              <div class="dashboard__order-history">
                <div class="dashboard__order-history-title">
                  ...
                  <a href="admin-orders.php">back to list</a>
                </div>
                      ...
                      <div class="dashboard__totalpayment-card">
                        ...
                        <div class="dashboard__totalpayment-card-body">
                          ...
                          <div class="dashboard__totalpayment-card-body-item">
                            ...
                            <p class="font-body--md-500">N<?php echo number_format($oqr['deliveryfee'], 0); ?></p>
                          </div>
                          <div
            ...
            <?php } if($oqr['deliverystatus']=='Delivered'){ ?>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        $vqq = mysqli_query($con, "SELECT * FROM users WHERE id='".$value['vendor']."'");
                        ...
                        <tr>
                          ...
                          >
                            ...
                            >
                              ...
                              <div style="margin-top:-20px"><a href="vendor.php?ref=<?php echo $vqr['username']; ?>" target="_blank" style="color:#00b207;font-weight:500"><div style="font-size:12px"><span style="font-weight:400;color:#333">Vendor:</span> <?php echo $vqr['fname']; ?> <?php echo $vqr['lname']; ?></a></div></div>
                            </a>
                          </td>
                          <!-- Price  -->
                          <td
                            ...
                            "
                          >
                            N<?php echo number_format($pqr['price'], 0); ?>
                          </td>
                          <!-- quantity -->
                          <td
                            class="
                          ...
                          >
                            <p class="font-body--md-500">N<?php echo number_format($value['total'], 0); ?></p>
                          </td>
                        </tr>
                      <?php } ?>
                      </tbody>
              ...
              <!-- Order Status -->
                <div class="col-lg-4" style="margin-top:20px">
                  ...
                  <input type="hidden" name="orderstatus" value="<?php echo $_GET['ref']; ?>">
            ...
            <div class="col-lg-8" style="margin-top:20px">
              ...
              <input type="hidden" name="orderRef" value="<?php echo $_GET['ref']; ?>">
              <div class="contact-form__content">
                ...
                <div class="contact-form-input">
                  ...
                  <option value="<?php echo $uqr['id']; ?>">Buyer</option>
