...
<head>
    ...
    <title>Manage Products | Expiring Soon</title>
    <link
      rel="icon"
      type="image/png"
        ...
        <div class="row dashboard__content">
          ...
          <div class="col-lg-9 section--xl pt-0" style="padding:10px;font-size:13px">
            <div class="dashboard__order-history-title" style="margin:auto;width:95%;border-bottom:1px solid #ddd;margin-bottom:10px">
              ...
              <a href="#" class="font-body--lg-500"><?php echo number_format($ttlproducts, 0); ?> Items</a>
            </div>
            <div class="container">
              <!-- Products -->
              <div class="table-responsive">
                <table id="datatable" class="table display" style="width:100%;font-size:13px">
                  ...
                  <tbody style="width:100%;font-size:13px">
                    <?php
                    // Fetch Products
                    $query = "SELECT * FROM products ORDER BY uploaded DESC LIMIT 50";
                    $proddata = mysqli_query($con,$query);
                    if (mysqli_num_rows($proddata) == 0) {
                    echo '<div style="margin:auto;padding:1%;text-align:center"><img style="padding:10px;width:100px" src="img/exclamation.png"><br />There are no products at this time.</span></a></div>';
                    }
                    ...
                    <tr class="likeditem" style="border-bottom:1px solid #f1f1f1">
                      ...
                      <td class="cart-table-item align-middle">
                        <a
                          href="admin-editproduct.php?pid=<?php echo $row['id']; ?>"
                        ...
                        >
                          ...
                          <h5 class="font-body--lg-400"><?php echo $row['product']; ?></h5>
                          <div style="margin-top:-10px">
                          <a href="vendor.php?ref=<?php echo $vqr['username']; ?>" target="_blank" style="color:#00b207;font-weight:500"><div style="font-size:12px"><span style="font-weight:400;color:#333">Vendor ID #<?php echo $vqr['id']; ?>:</span> <?php echo $vqr['fname']; ?> <?php echo $vqr['lname']; ?></a></div>
                        <?php if($row['expiry']!=='' AND $row['status']=='Expired'){ ?>
                      ...
                      <td class="cart-table-item order-date align-middle">
                        <p class="font-body--lg-500">N<?php echo number_format($row['price'], 2); ?></p>
                      </td>
                      <!-- Stock Status  -->
                      <td class="cart-table-item stock-status order-date align-middle">
                        <?php if($row['stock'] > 0){ ?>
                        <span class="font-body--md-400 in"><?php echo $row['stock']; ?></span>
                      <?php } else{ ?>
                        <span class="font-body--md-400 out"><?php echo $row['stock']; ?></span>
                      <?php } ?>

                      </td>
                      <td class="cart-table-item add-cart align-middle">
                      <?php
                      $check = mysqli_query($con, "SELECT * FROM featured WHERE productid='".$row['id']."'");
