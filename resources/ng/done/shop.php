...
<head>
        ...
        <title>Shop | Expiring Soon</title>
        ...
        <div class="breedcrumb breedcrumb--two">
            <div class="container">
                <ul class="breedcrumb__content">
                    ...
                    <li class="active"><a href="#" id="active"><?php echo $activecatname; ?> </a></li>
                </ul>
            </div>
        </div>
        ...
        <section class="banner-sales">
            <div class="container">
                <div class="banner-sales__content">
                    <img src="src/images/banner/banner-lg-17.jpg" alt="banner" />
                    <div class="text-content">
            ...
            <div class="filter-box">
                <div class="container">
                    <div class="filter-box__top">
                        ...
                        <!-- <select id="category" class="filter__dropdown-menu" onchange="location = this.value;">-->
                                  <?php if(isset($_GET['cat']) && empty($_GET['cid'])){ ?>
                                    <option value="<?php echo $_GET['cat']; ?>" selected><?php echo $cqr['category']; ?></option>
                                  <?php
                                  }
                                  // Fetch Categories
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row shop__product-items">
                          ...
                          // Fetch Products
                          if(isset($_GET['cat']) && empty($_GET['cid'])){
                          $query = "SELECT * FROM products WHERE cat_id='".$_GET['cat']."' AND status='Listed' ORDER BY uploaded DESC LIMIT 200";
                          }
                          if(empty($_GET['cat']) && empty($_GET['cid'])){
