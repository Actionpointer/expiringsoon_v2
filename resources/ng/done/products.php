...
<head>
    ...
    <title>My Products | Expiring Soon</title>
    <link
      rel="icon"
      type="image/png"
      ...
      <div class="breedcrumb__img-wrapper">
        ...
        <div class="container">
          <ul class="breedcrumb__content">
            ...
            <li class="active"><a href="products.php">My Products</a></li>
          </ul>
        </div>
      </div>
    </div>
                  ...
                  <div class="table-responsive">
                    <table id="datatable" class="table display" style="width:100%;font-size:13px">
                      ...
                      <tbody>
                        <?php
                        // Fetch Products
                        $query = "SELECT * FROM products WHERE userid='".$uqr['id']."' ORDER BY uploaded DESC LIMIT 50";
                        ...
                        $expires = date("l, M jS Y", strtotime($row['expiry']));
                        ...
                        <tr class="likeditem" style="border-bottom:1px solid #f1f1f1">
                          ...
                          <td class="cart-table-item align-middle">
                            <a
                              href="editproduct.php?pid=<?php echo $row['id']; ?>"
                            ...
                            >
                              ...
                              <h5 class="font-body--lg-400" style="font-size:14px"><?php echo $row['product']; ?></h5>
                            </a>
                            <?php if($row['expiry']!=='' AND $row['status']=='Listed'){ ?>
                            <ul class="d-flex" style="margin-top:10px;color:#888;font-size:12px">
                              <li>Expires <span style="font-weight:550;color:#00b207"><?php echo $expires; ?> | <?php echo $numberDays; ?> days</span><li>
                            </ul>
