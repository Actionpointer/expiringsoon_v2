...
<head>
    ...
    <title>Settings | Expiring Soon</title>
    <link
      rel="icon"
      type="image/png"
  ...
  event.preventDefault();
  $("#process4").html("Saving...");
  $.post('process.php', $(this).serialize(), function(data) {
  $('#process4').html(data).css('color', '#00b207');
  });
});
...
e.preventDefault();
if(confirm("This Admin account will be removed. Are you sure?")){
var adminid = $(this).attr("id5");
var info = 'id5=' + adminid;
 $.ajax({
   type: "GET",
   url: "process.php",
   data: info,
...
$(this).parents(".adminrow").animate({ backgroundColor: "#fff" }, "fast")
          ...
          <div class="col-lg-9 section--xl pt-0">
            <div class="container">
                    ...
                    <div class="contact-form__content">
                      <div class="contact-form-input">
                        ...
                        <input
                          type="text"
                          name="vat"
                          placeholder"Set VAT Percentage"
                          value="<?php echo $stqr['vat']; ?>"
                    ...
                    <div class="contact-form__content">
                      <div class="contact-form-input">
                        ...
                        <input
                          type="text"
                          name="minpayout"
                          placeholder"Set Min. Payout"
                          value="<?php echo $stqr['payout']; ?>"
                          onkeypress="validate(event)"
                        />
                      </div>
              ...
              <div class="dashboard__content-card">
                ...
                <div class="dashboard__content-card-body">
                  <div id="process3"><?php include("getAdmins.php"); ?></div>
