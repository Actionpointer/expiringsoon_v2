...
var loadFile = function(event) {
        ...
        <div class="row dashboard__content">
          ...
          <div class="col-lg-9 section--xl pt-0">
            <div class="container">
              ...
              <div class="dashboard__content-card">
                <div class="dashboard__content-card-header">
                  <h5 class="font-body--xxl-500">Delivery Address</h5>
                </div>
                <div class="dashboard__content-card-body">
              ...
              <div class="dashboard__content-card">
                <div class="dashboard__content-card-header">
                  <h5 class="font-body--xxl-500">Discounts</h5>
                </div>
                <div class="dashboard__content-card-body">
              ...
              <div class="dashboard__content-card" id="topUpSection">
                <div class="dashboard__content-card-header">
                  <h5 class="font-body--xxl-500">Top-Up Wallet</h5>
                </div>
                <div class="dashboard__content-card-body">
                  <form method="post">
  ...
  function makePayment() {
    ...
    var addUrl = "expiringsoon.shop/topup.php?amount=";
    FlutterwaveCheckout({
      public_key: "FLWPUBK_TEST-e95e5adced4868060e1624a4d2523477-X",
      ...
      logo: "https://expiringsoon.shop/src/images/logo.png",
      },
    });
  }
</script>
              ...
              <div class="dashboard__content-card">
                <div class="dashboard__content-card-header">
                  <h5 class="font-body--xxl-500">Change Password</h5>
                </div>
                <div class="dashboard__content-card-body">
                  <form action="#">
                    <div class="contact-form__content">
