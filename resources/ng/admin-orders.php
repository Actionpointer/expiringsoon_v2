...
$sum = "SELECT sum(total) as ttorders FROM orders WHERE deliverystatus='Delivered'";
$res = mysqli_query($con, $sum);
while ($row = mysqli_fetch_array($res)){
$ttlorders = $row['ttorders'];
}
...
<head>
    ...
    <title>Manage Orders | Expiring Soon</title>
    <link
      rel="icon"
      type="image/png"
            ...
            <div class="container">
              ...
              <div class="dashboard__order-history">
                <div class="dashboard__order-history-title">
                  <h2 class="font-body--xl-500">Manage Orders</h2>
                  <a href="#" class="font-body--lg-500"><?php echo number_format($ttl_orders, 0); ?> Total | N<?php echo number_format($ttlorders, 0); ?></a>
                </div>
                    ...
                    <div class="table-responsive">
                      <table id="datatable" class="table display" style="width:100%;font-size:13px">
                          ...
                          <tbody style="margin-bottom:10px">
                            ...
                            $vat = ($stqr['vat'] / 100) * $row['total'];
                            $finalttl = $vat + ($row['total'] + $row['deliveryfee']);
                            ?>
                              <tr>
                                  <td>#<?php echo $row['orderid']; ?></td>
                                  <td><?php echo $row['dateadded']; ?></td>
                                  <td><span style="font-weight:550">N<?php echo number_format($finalttl, 0); ?></span></td>
                                  <td><?php echo $row['deliverystatus']; ?></td>
                                  <td><?php if($row['deliverystatus']=='Incomplete'){ ?>
                                    <a href="admin-invoice.php?ref=<?php echo $row['orderid']; ?>" style="color:#00b207"> Inomplete Order</a>
                                  <?php } else{ ?>
                                    <a href="admin-invoice.php?ref=<?php echo $row['orderid']; ?>" style="color:#00b207"> View Details</a>
                                  <?php } ?></td>
                              </tr>
                            <?php } ?>
                          </tbody>
