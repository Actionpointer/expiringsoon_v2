...
$email_string = strtolower($username);
$user = mysqli_query($con, "SELECT * FROM users WHERE email='$email_string'");
...
$mail->Body = file_get_contents("https://expiring.soon/forgot.php?uid=".$mqr['id']."");
$mail->send();
    ...
    <section class="sign-in section section--xl">
      <div class="container">
        <div class="form-wrapper">
          <h6 class="font-title--sm" style="font-size:16px">Password Reset</h6>
          <div class="form-register" style="margin-top:-25px;margin-bottom:15px">Enter registered email to receive password reset link.</div>
          <form method="post">
            ...
            <div class="form-button">
              <button type="submit" class="button button--md w-100">Send Reset Link</button>
            </div>
